...
static int CAPDB_TCLAPI test_vdbe_coverage(
  ClientData cd,
  Tcl_Interp *interp,
  int objc,
  Tcl_Obj *CONST objv[]
  ...
  switch( iSub ){
    case 0:       /* start */
      ...
      capdb_test_control(CAPDB_TESTCTRL_VDBE_COVERAGE, test_vdbe_branch, 0);
      break;
    case 1: {     /* report */
      int i;
    ...
    default:      /* stop */         
      capdb_test_control(CAPDB_TESTCTRL_VDBE_COVERAGE, 0, 0);
      break;
  }

...
** source file "/home/megalith/CapperVM/CapDB/core/parse.y".
*/
/*
** 2001-09-15
**
...
*/
#line 64 "/home/megalith/CapperVM/CapDB/core/parse.y"
...
#line 537 "/home/megalith/CapperVM/CapDB/core/parse.y"
...
#line 1137 "/home/megalith/CapperVM/CapDB/core/parse.y"
...
#line 1385 "/home/megalith/CapperVM/CapDB/core/parse.y"
...
#line 1657 "/home/megalith/CapperVM/CapDB/core/parse.y"
...
#line 2151 "/home/megalith/CapperVM/CapDB/core/parse.y"

#if TK_SPAN>255
# error too many tokens in the grammar
#endif
#line 304 "/home/megalith/CapperVM/CapDB/core/parse.c"
...
**                       token.
**    capdbParserTOKENTYPE     is the data type used for minor type for terminal
...
**                       which is capdbParserTOKENTYPE.  The entry in the union
**                       for terminal symbols is called "yy0".
**    YYSTACKDEPTH       is the maximum depth of the parser's stack.  If
**                       zero the stack is dynamically sized using realloc()
**    capdbParserARG_SDECL     A static variable declaration for the %extra_argument
**    capdbParserARG_PDECL     A parameter declaration for the %extra_argument
**    capdbParserARG_PARAM     Code to pass %extra_argument as a subroutine parameter
**    capdbParserARG_STORE     Code to store %extra_argument into yypParser
**    capdbParserARG_FETCH     Code to extract %extra_argument from yypParser
**    capdbParserCTX_*         As capdbParserARG_ except for %extra_context
...
#define capdbParserTOKENTYPE Token
typedef union {
  int yyinit;
  capdbParserTOKENTYPE yy0;
  ExprList* yy14;
  With* yy59;
  Cte* yy67;
  Upsert* yy122;
...
#endif
#define capdbParserARG_SDECL
#define capdbParserARG_PDECL
#define capdbParserARG_PARAM
#define capdbParserARG_FETCH
#define capdbParserARG_STORE
#undef YYREALLOC
...
#define capdbParserCTX(P) ((P)->pParse)
#define capdbParserCTX_SDECL Parse *pParse;
#define capdbParserCTX_PDECL ,Parse *pParse
#define capdbParserCTX_PARAM ,pParse
#define capdbParserCTX_FETCH Parse *pParse=yypParser->pParse;
#define capdbParserCTX_STORE yypParser->pParse=pParse;
#undef YYERRORSYMBOL
#undef YYERRSYMDT
#undef YYFALLBACK
#define YYFALLBACK 1
...
#endif
  capdbParserARG_SDECL                /* A place to hold %extra_argument */
  capdbParserCTX_SDECL                /* A place to hold %extra_context */
...
** None.
*/
void capdbParserTrace(FILE *TraceFILE, char *zTracePrompt){
...
static int yyGrowStack(yyParser *p){
  ...
  yyStackEntry *pNew;
#ifdef YYSIZELIMIT
  int nLimit = YYSIZELIMIT(capdbParserCTX(p));
#endif
  ...
  if( p->yystack==p->yystk0 ){
    pNew = YYREALLOC(0, newSize*sizeof(pNew[0]), capdbParserCTX(p));
    if( pNew==0 ) return 1;
    memcpy(pNew, p->yystack, oldSize*sizeof(pNew[0]));
  }else{
    pNew = YYREALLOC(p->yystack, newSize*sizeof(pNew[0]), capdbParserCTX(p));
    if( pNew==0 ) return 1;
  }
  p->yystack = pNew;
...
** second argument to capdbParserAlloc() below.  This can be changed by
...
*/
void capdbParserInit(void *yypRawParser capdbParserCTX_PDECL){
  yyParser *yypParser = (yyParser*)yypRawParser;
  capdbParserCTX_STORE
#ifdef YYTRACKMAXSTACKDEPTH
  yypParser->yyhwm = 0;
#endif
...
#ifndef capdbParser_ENGINEALWAYSONSTACK
/* 
...
** to capdbParser and capdbParserFree.
*/
void *capdbParserAlloc(void *(*mallocProc)(YYMALLOCARGTYPE) capdbParserCTX_PDECL){
  yyParser *yypParser;
  yypParser = (yyParser*)(*mallocProc)( (YYMALLOCARGTYPE)sizeof(yyParser) );
  if( yypParser ){
    capdbParserCTX_STORE
    capdbParserInit(yypParser capdbParserCTX_PARAM);
  }
  return (void*)yypParser;
}
#endif /* capdbParser_ENGINEALWAYSONSTACK */
...
static void yy_destructor(
  ...
  capdbParserARG_FETCH
  capdbParserCTX_FETCH
  switch( yymajor ){
...
/********* Begin destructor definitions ***************************************/
    ...
    case 256: /* mvalues */
{
#line 531 "/home/megalith/CapperVM/CapDB/core/parse.y"
capdbSelectDelete(pParse->db, (yypminor->yy555));
#line 2551 "/home/megalith/CapperVM/CapDB/core/parse.c"
}
      break;
    case 218: /* term */
    case 219: /* expr */
...
{
#line 1135 "/home/megalith/CapperVM/CapDB/core/parse.y"
capdbExprDelete(pParse->db, (yypminor->yy454));
#line 2568 "/home/megalith/CapperVM/CapDB/core/parse.c"
}
      break;
    ...
    case 313: /* part_opt */
{
#line 1655 "/home/megalith/CapperVM/CapDB/core/parse.y"
capdbExprListDelete(pParse->db, (yypminor->yy14));
#line 2587 "/home/megalith/CapperVM/CapDB/core/parse.c"
}
      break;
    case 240: /* fullname */
    case 247: /* from */
    ...
    case 265: /* xfullname */
{
#line 824 "/home/megalith/CapperVM/CapDB/core/parse.y"
capdbSrcListDelete(pParse->db, (yypminor->yy203));
#line 2598 "/home/megalith/CapperVM/CapDB/core/parse.c"
}
      break;
    case 243: /* wqlist */
{
#line 1951 "/home/megalith/CapperVM/CapDB/core/parse.y"
capdbWithDelete(pParse->db, (yypminor->yy59));
#line 2605 "/home/megalith/CapperVM/CapDB/core/parse.c"
}
      break;
    case 253: /* window_clause */
    case 309: /* windowdefn_list */
{
#line 2080 "/home/megalith/CapperVM/CapDB/core/parse.y"
capdbWindowListDelete(pParse->db, (yypminor->yy211));
#line 2613 "/home/megalith/CapperVM/CapDB/core/parse.c"
}
      break;
    case 266: /* idlist */
    case 273: /* idlist_opt */
{
#line 1120 "/home/megalith/CapperVM/CapDB/core/parse.y"
capdbIdListDelete(pParse->db, (yypminor->yy132));
#line 2621 "/home/megalith/CapperVM/CapDB/core/parse.c"
}
      break;
...
{
#line 2019 "/home/megalith/CapperVM/CapDB/core/parse.y"
capdbWindowDelete(pParse->db, (yypminor->yy211));
#line 2632 "/home/megalith/CapperVM/CapDB/core/parse.c"
}
      break;
    case 289: /* trigger_cmd_list */
    case 294: /* trigger_cmd */
{
#line 1774 "/home/megalith/CapperVM/CapDB/core/parse.y"
capdbDeleteTriggerStep(pParse->db, (yypminor->yy427));
#line 2640 "/home/megalith/CapperVM/CapDB/core/parse.c"
}
      break;
    case 291: /* trigger_event */
{
#line 1760 "/home/megalith/CapperVM/CapDB/core/parse.y"
capdbIdListDelete(pParse->db, (yypminor->yy286).b);
#line 2647 "/home/megalith/CapperVM/CapDB/core/parse.c"
}
      break;
...
{
#line 2024 "/home/megalith/CapperVM/CapDB/core/parse.y"
capdbExprDelete(pParse->db, (yypminor->yy509).pExpr);
#line 2656 "/home/megalith/CapperVM/CapDB/core/parse.c"
}
      break;
...
*/
void capdbParserFinalize(void *p){
  ...
  ** element left in the stack */
  ...
  if( pParser->yystack!=pParser->yystk0 ){
    YYFREE(pParser->yystack, capdbParserCTX(pParser));
  }
#endif
}
...
*/
#ifdef YYTRACKMAXSTACKDEPTH
int capdbParserStackPeak(void *p){
  yyParser *pParser = (yyParser*)p;
...
*/
#if defined(YYCOVERAGE)
int capdbParserCoverage(FILE *out){
...
#line 53 "/home/megalith/CapperVM/CapDB/core/parse.y"

  if( pParse->nErr==0 ) capdbErrorMsg(pParse, "Recursion limit");
#line 2896 "/home/megalith/CapperVM/CapDB/core/parse.c"
/******** End %stack_overflow code ********************************************/
   capdbParserARG_STORE /* Suppress warning about unused %extra_argument var */
   capdbParserCTX_STORE
}
...
static void yy_shift(
  ...
  capdbParserTOKENTYPE yyMinor        /* The minor token to shift in */
){
  yyStackEntry *yytos;
  yypParser->yytos++;
#ifdef YYTRACKMAXSTACKDEPTH
...
static YYACTIONTYPE yy_reduce(
  ...
  capdbParserTOKENTYPE yyLookaheadToken  /* Value of the lookahead token */
  capdbParserCTX_PDECL                   /* %extra_context */
){
...
#line 173 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ if( pParse->pReprepare==0 ) pParse->explain = 1; }
#line 3835 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 1: /* explain ::= EXPLAIN QUERY PLAN */
#line 174 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ if( pParse->pReprepare==0 ) pParse->explain = 2; }
#line 3840 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 2: /* cmdx ::= cmd */
#line 176 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ capdbFinishCoding(pParse); }
#line 3845 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 3: /* cmd ::= BEGIN transtype trans_opt */
#line 181 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbBeginTransaction(pParse, yymsp[-1].minor.yy144);}
#line 3850 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 4: /* transtype ::= */
#line 186 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[1].minor.yy144 = TK_DEFERRED;}
#line 3855 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 5: /* transtype ::= DEFERRED */
      case 6: /* transtype ::= IMMEDIATE */ yytestcase(yyruleno==6);
      case 7: /* transtype ::= EXCLUSIVE */ yytestcase(yyruleno==7);
      case 328: /* range_or_rows ::= RANGE|ROWS|GROUPS */ yytestcase(yyruleno==328);
#line 187 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[0].minor.yy144 = yymsp[0].major; /*A-overwrites-X*/}
#line 3863 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 8: /* cmd ::= COMMIT|END trans_opt */
      case 9: /* cmd ::= ROLLBACK trans_opt */ yytestcase(yyruleno==9);
#line 190 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbEndTransaction(pParse,yymsp[-1].major);}
#line 3869 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 10: /* cmd ::= SAVEPOINT nm */
#line 195 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbSavepoint(pParse, SAVEPOINT_BEGIN, &yymsp[0].minor.yy0);
}
#line 3876 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 11: /* cmd ::= RELEASE savepoint_opt nm */
#line 198 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbSavepoint(pParse, SAVEPOINT_RELEASE, &yymsp[0].minor.yy0);
}
#line 3883 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 12: /* cmd ::= ROLLBACK trans_opt TO savepoint_opt nm */
#line 201 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbSavepoint(pParse, SAVEPOINT_ROLLBACK, &yymsp[0].minor.yy0);
}
#line 3890 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 13: /* create_table ::= createkw temp TABLE ifnotexists nm dbnm */
#line 208 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
   capdbStartTable(pParse,&yymsp[-1].minor.yy0,&yymsp[0].minor.yy0,yymsp[-4].minor.yy144,0,0,yymsp[-2].minor.yy144);
}
#line 3897 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 14: /* createkw ::= CREATE */
#line 211 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  disableLookaside(pParse);
}
#line 3904 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 15: /* ifnotexists ::= */
...
#line 216 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[1].minor.yy144 = 0;}
#line 3916 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 16: /* ifnotexists ::= IF NOT EXISTS */
#line 217 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-2].minor.yy144 = 1;}
#line 3921 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 17: /* temp ::= TEMP */
#line 220 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[0].minor.yy144 = pParse->db->init.busy==0;}
#line 3926 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 19: /* create_table_args ::= LP columnlist conslist_opt RP table_option_set */
#line 223 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbEndTable(pParse,&yymsp[-2].minor.yy0,&yymsp[-1].minor.yy0,yymsp[0].minor.yy391,0);
}
#line 3933 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 20: /* create_table_args ::= AS select */
#line 226 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbEndTable(pParse,0,0,0,yymsp[0].minor.yy555);
  capdbSelectDelete(pParse->db, yymsp[0].minor.yy555);
}
#line 3941 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 21: /* table_option_set ::= */
#line 232 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[1].minor.yy391 = 0;}
#line 3946 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 22: /* table_option_set ::= table_option_set COMMA table_option */
#line 234 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yylhsminor.yy391 = yymsp[-2].minor.yy391|yymsp[0].minor.yy391;}
#line 3951 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-2].minor.yy391 = yylhsminor.yy391;
        break;
      case 23: /* table_option ::= WITHOUT nm */
#line 235 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  if( yymsp[0].minor.yy0.n==5 && capdb_strnicmp(yymsp[0].minor.yy0.z,"rowid",5)==0 ){
    yymsp[-1].minor.yy391 = TF_WithoutRowid | TF_NoVisibleRowid;
  }else{
    yymsp[-1].minor.yy391 = 0;
    capdbErrorMsg(pParse, "unknown table option: %.*s", yymsp[0].minor.yy0.n, yymsp[0].minor.yy0.z);
  }
}
#line 3964 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 24: /* table_option ::= nm */
#line 243 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  if( yymsp[0].minor.yy0.n==6 && capdb_strnicmp(yymsp[0].minor.yy0.z,"strict",6)==0 ){
...
#line 3976 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[0].minor.yy391 = yylhsminor.yy391;
        break;
      case 25: /* columnname ::= nm typetoken */
#line 253 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbAddColumn(pParse,yymsp[-1].minor.yy0,yymsp[0].minor.yy0);}
#line 3982 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 26: /* typetoken ::= */
      case 65: /* conslist_opt ::= */ yytestcase(yyruleno==65);
      case 106: /* as ::= */ yytestcase(yyruleno==106);
#line 347 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[1].minor.yy0.n = 0; yymsp[1].minor.yy0.z = 0;}
#line 3989 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 27: /* typetoken ::= typename LP signed RP */
#line 349 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-3].minor.yy0.n = (int)(&yymsp[0].minor.yy0.z[yymsp[0].minor.yy0.n] - yymsp[-3].minor.yy0.z);
}
#line 3996 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 28: /* typetoken ::= typename LP signed COMMA signed RP */
#line 352 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-5].minor.yy0.n = (int)(&yymsp[0].minor.yy0.z[yymsp[0].minor.yy0.n] - yymsp[-5].minor.yy0.z);
}
#line 4003 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 29: /* typename ::= typename ID|STRING */
#line 357 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-1].minor.yy0.n=yymsp[0].minor.yy0.n+(int)(yymsp[0].minor.yy0.z-yymsp[-1].minor.yy0.z);}
#line 4008 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 30: /* scanpt ::= */
#line 375 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  assert( yyLookahead!=YYNOCODE );
  yymsp[1].minor.yy168 = yyLookaheadToken.z;
}
#line 4016 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 31: /* scantok ::= */
#line 379 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  assert( yyLookahead!=YYNOCODE );
  yymsp[1].minor.yy0 = yyLookaheadToken;
}
#line 4024 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 32: /* ccons ::= CONSTRAINT nm */
      case 67: /* tcons ::= CONSTRAINT nm */ yytestcase(yyruleno==67);
#line 389 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ASSERT_IS_CREATE; pParse->u1.cr.constraintName = yymsp[0].minor.yy0;}
#line 4030 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 33: /* ccons ::= DEFAULT scantok term */
#line 391 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbAddDefaultValue(pParse,yymsp[0].minor.yy454,yymsp[-1].minor.yy0.z,&yymsp[-1].minor.yy0.z[yymsp[-1].minor.yy0.n]);}
#line 4035 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 34: /* ccons ::= DEFAULT LP expr RP */
#line 393 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbAddDefaultValue(pParse,yymsp[-1].minor.yy454,yymsp[-2].minor.yy0.z+1,yymsp[0].minor.yy0.z);}
#line 4040 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 35: /* ccons ::= DEFAULT PLUS scantok term */
#line 395 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbAddDefaultValue(pParse,yymsp[0].minor.yy454,yymsp[-2].minor.yy0.z,&yymsp[-1].minor.yy0.z[yymsp[-1].minor.yy0.n]);}
#line 4045 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 36: /* ccons ::= DEFAULT MINUS scantok term */
#line 396 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  Expr *p = capdbPExpr(pParse, TK_UMINUS, yymsp[0].minor.yy454, 0);
  capdbAddDefaultValue(pParse,p,yymsp[-2].minor.yy0.z,&yymsp[-1].minor.yy0.z[yymsp[-1].minor.yy0.n]);
}
#line 4053 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 37: /* ccons ::= DEFAULT scantok ID|INDEXED */
#line 400 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  ...
  if( p ){
    ...
    capdbAddDefaultValue(pParse,p,yymsp[0].minor.yy0.z,yymsp[0].minor.yy0.z+yymsp[0].minor.yy0.n);
}
#line 4065 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 38: /* ccons ::= NOT NULL onconf */
#line 413 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbAddNotNull(pParse, yymsp[0].minor.yy144);}
#line 4070 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 39: /* ccons ::= PRIMARY KEY sortorder onconf autoinc */
#line 415 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbAddPrimaryKey(pParse,0,yymsp[-1].minor.yy144,yymsp[0].minor.yy144,yymsp[-2].minor.yy144);}
#line 4075 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 40: /* ccons ::= UNIQUE onconf */
#line 416 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbCreateIndex(pParse,0,0,0,0,yymsp[0].minor.yy144,0,0,0,0,
                                   CAPDB_IDXTYPE_UNIQUE);}
#line 4081 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 41: /* ccons ::= CHECK LP expr RP */
#line 418 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbAddCheckConstraint(pParse,yymsp[-1].minor.yy454,yymsp[-2].minor.yy0.z,yymsp[0].minor.yy0.z);}
#line 4086 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 42: /* ccons ::= REFERENCES nm eidlist_opt refargs */
#line 420 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbCreateForeignKey(pParse,0,&yymsp[-2].minor.yy0,yymsp[-1].minor.yy14,yymsp[0].minor.yy144);}
#line 4091 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 43: /* ccons ::= defer_subclause */
#line 421 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbDeferForeignKey(pParse,yymsp[0].minor.yy144);}
#line 4096 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 44: /* ccons ::= COLLATE ID|STRING */
#line 422 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbAddCollateType(pParse, &yymsp[0].minor.yy0);}
#line 4101 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 45: /* generated ::= LP expr RP */
#line 425 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbAddGenerated(pParse,yymsp[-1].minor.yy454,0);}
#line 4106 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 46: /* generated ::= LP expr RP ID */
#line 426 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbAddGenerated(pParse,yymsp[-2].minor.yy454,&yymsp[0].minor.yy0);}
#line 4111 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 48: /* autoinc ::= AUTOINCR */
#line 431 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[0].minor.yy144 = 1;}
#line 4116 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 49: /* refargs ::= */
#line 439 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[1].minor.yy144 = OE_None*0x0101; /* EV: R-19803-45884 */}
#line 4121 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 50: /* refargs ::= refargs refarg */
#line 440 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[-1].minor.yy144 = (yymsp[-1].minor.yy144 & ~yymsp[0].minor.yy383.mask) | yymsp[0].minor.yy383.value; }
#line 4126 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 51: /* refarg ::= MATCH nm */
#line 442 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[-1].minor.yy383.value = 0;     yymsp[-1].minor.yy383.mask = 0x000000; }
#line 4131 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 52: /* refarg ::= ON INSERT refact */
#line 443 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[-2].minor.yy383.value = 0;     yymsp[-2].minor.yy383.mask = 0x000000; }
#line 4136 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 53: /* refarg ::= ON DELETE refact */
#line 444 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[-2].minor.yy383.value = yymsp[0].minor.yy144;     yymsp[-2].minor.yy383.mask = 0x0000ff; }
#line 4141 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 54: /* refarg ::= ON UPDATE refact */
#line 445 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[-2].minor.yy383.value = yymsp[0].minor.yy144<<8;  yymsp[-2].minor.yy383.mask = 0x00ff00; }
#line 4146 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 55: /* refact ::= SET NULL */
#line 447 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[-1].minor.yy144 = OE_SetNull;  /* EV: R-33326-45252 */}
#line 4151 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 56: /* refact ::= SET DEFAULT */
#line 448 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[-1].minor.yy144 = OE_SetDflt;  /* EV: R-33326-45252 */}
#line 4156 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 57: /* refact ::= CASCADE */
#line 449 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[0].minor.yy144 = OE_Cascade;  /* EV: R-33326-45252 */}
#line 4161 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 58: /* refact ::= RESTRICT */
#line 450 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[0].minor.yy144 = OE_Restrict; /* EV: R-33326-45252 */}
#line 4166 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 59: /* refact ::= NO ACTION */
#line 451 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[-1].minor.yy144 = OE_None;     /* EV: R-33326-45252 */}
#line 4171 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 60: /* defer_subclause ::= NOT DEFERRABLE init_deferred_pred_opt */
#line 453 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-2].minor.yy144 = 0;}
#line 4176 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 61: /* defer_subclause ::= DEFERRABLE init_deferred_pred_opt */
      case 76: /* orconf ::= OR resolvetype */ yytestcase(yyruleno==76);
      case 173: /* insert_cmd ::= INSERT orconf */ yytestcase(yyruleno==173);
#line 454 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-1].minor.yy144 = yymsp[0].minor.yy144;}
#line 4183 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
...
#line 457 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-1].minor.yy144 = 1;}
#line 4192 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 64: /* init_deferred_pred_opt ::= INITIALLY IMMEDIATE */
#line 458 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-1].minor.yy144 = 0;}
#line 4197 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 66: /* tconscomma ::= COMMA */
#line 464 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ASSERT_IS_CREATE; pParse->u1.cr.constraintName.n = 0;}
#line 4202 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 68: /* tcons ::= PRIMARY KEY LP sortlist autoinc RP onconf */
#line 468 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbAddPrimaryKey(pParse,yymsp[-3].minor.yy14,yymsp[0].minor.yy144,yymsp[-2].minor.yy144,0);}
#line 4207 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 69: /* tcons ::= UNIQUE LP sortlist RP onconf */
#line 470 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbCreateIndex(pParse,0,0,0,yymsp[-2].minor.yy14,yymsp[0].minor.yy144,0,0,0,0,
                                       CAPDB_IDXTYPE_UNIQUE);}
#line 4213 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 70: /* tcons ::= CHECK LP expr RP onconf */
#line 473 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbAddCheckConstraint(pParse,yymsp[-2].minor.yy454,yymsp[-3].minor.yy0.z,yymsp[-1].minor.yy0.z);}
#line 4218 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 71: /* tcons ::= FOREIGN KEY LP eidlist RP REFERENCES nm eidlist_opt refargs defer_subclause_opt */
#line 475 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
    capdbCreateForeignKey(pParse, yymsp[-6].minor.yy14, &yymsp[-3].minor.yy0, yymsp[-2].minor.yy14, yymsp[-1].minor.yy144);
    capdbDeferForeignKey(pParse, yymsp[0].minor.yy144);
}
#line 4226 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 73: /* onconf ::= */
      case 75: /* orconf ::= */ yytestcase(yyruleno==75);
#line 489 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[1].minor.yy144 = OE_Default;}
#line 4232 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 74: /* onconf ::= ON CONFLICT resolvetype */
#line 490 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-2].minor.yy144 = yymsp[0].minor.yy144;}
#line 4237 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 77: /* resolvetype ::= IGNORE */
#line 494 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[0].minor.yy144 = OE_Ignore;}
#line 4242 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 78: /* resolvetype ::= REPLACE */
      case 174: /* insert_cmd ::= REPLACE */ yytestcase(yyruleno==174);
#line 495 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[0].minor.yy144 = OE_Replace;}
#line 4248 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 79: /* cmd ::= DROP TABLE ifexists fullname */
#line 499 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbDropTable(pParse, yymsp[0].minor.yy203, 0, yymsp[-1].minor.yy144);
}
#line 4255 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 82: /* cmd ::= createkw temp VIEW ifnotexists nm dbnm eidlist_opt AS select */
#line 510 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbCreateView(pParse, &yymsp[-8].minor.yy0, &yymsp[-4].minor.yy0, &yymsp[-3].minor.yy0, yymsp[-2].minor.yy14, yymsp[0].minor.yy555, yymsp[-7].minor.yy144, yymsp[-5].minor.yy144);
}
#line 4262 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 83: /* cmd ::= DROP VIEW ifexists fullname */
#line 513 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbDropTable(pParse, yymsp[0].minor.yy203, 1, yymsp[-1].minor.yy144);
}
#line 4269 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 84: /* cmd ::= select */
#line 520 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  SelectDest dest = {SRT_Output, 0, 0, 0, 0, 0, 0};
  if( (pParse->db->mDbFlags & DBFLAG_EncodingFixed)!=0
   || capdbReadSchema(pParse)==CAPDB_OK
  ){
    capdbSelect(pParse, yymsp[0].minor.yy555, &dest);
  }
  capdbSelectDelete(pParse->db, yymsp[0].minor.yy555);
}
#line 4282 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 85: /* select ::= WITH wqlist selectnowith */
#line 609 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-2].minor.yy555 = attachWithToSelect(pParse,yymsp[0].minor.yy555,yymsp[-1].minor.yy59);}
#line 4287 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 86: /* select ::= WITH RECURSIVE wqlist selectnowith */
#line 611 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-3].minor.yy555 = attachWithToSelect(pParse,yymsp[0].minor.yy555,yymsp[-1].minor.yy59);}
#line 4292 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 87: /* select ::= selectnowith */
#line 614 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
...
#line 4302 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 88: /* selectnowith ::= selectnowith multiselect_op oneselect */
#line 623 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
...
#line 4328 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 89: /* multiselect_op ::= UNION */
      case 91: /* multiselect_op ::= EXCEPT|INTERSECT */ yytestcase(yyruleno==91);
#line 646 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[0].minor.yy144 = yymsp[0].major; /*A-overwrites-OP*/}
#line 4334 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 90: /* multiselect_op ::= UNION ALL */
#line 647 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-1].minor.yy144 = TK_ALL;}
#line 4339 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 92: /* oneselect ::= SELECT distinct selcollist from where_opt groupby_opt having_opt orderby_opt limit_opt */
#line 653 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-8].minor.yy555 = capdbSelectNew(pParse,yymsp[-6].minor.yy14,yymsp[-5].minor.yy203,yymsp[-4].minor.yy454,yymsp[-3].minor.yy14,yymsp[-2].minor.yy454,yymsp[-1].minor.yy14,yymsp[-7].minor.yy144,yymsp[0].minor.yy454);
}
#line 4346 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 93: /* oneselect ::= SELECT distinct selcollist from where_opt groupby_opt having_opt window_clause orderby_opt limit_opt */
#line 659 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-9].minor.yy555 = capdbSelectNew(pParse,yymsp[-7].minor.yy14,yymsp[-6].minor.yy203,yymsp[-5].minor.yy454,yymsp[-4].minor.yy14,yymsp[-3].minor.yy454,yymsp[-1].minor.yy14,yymsp[-8].minor.yy144,yymsp[0].minor.yy454);
  if( yymsp[-9].minor.yy555 ){
    yymsp[-9].minor.yy555->pWinDefn = yymsp[-2].minor.yy211;
  }else{
    capdbWindowListDelete(pParse->db, yymsp[-2].minor.yy211);
  }
}
#line 4358 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 94: /* values ::= VALUES LP nexprlist RP */
#line 675 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-3].minor.yy555 = capdbSelectNew(pParse,yymsp[-1].minor.yy14,0,0,0,0,0,SF_Values,0);
}
#line 4365 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 95: /* oneselect ::= mvalues */
#line 682 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbMultiValuesEnd(pParse, yymsp[0].minor.yy555);
}
#line 4372 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 96: /* mvalues ::= values COMMA LP nexprlist RP */
      case 97: /* mvalues ::= mvalues COMMA LP nexprlist RP */ yytestcase(yyruleno==97);
#line 686 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-4].minor.yy555 = capdbMultiValues(pParse, yymsp[-4].minor.yy555, yymsp[-1].minor.yy14);
}
#line 4380 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 98: /* distinct ::= DISTINCT */
#line 697 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[0].minor.yy144 = SF_Distinct;}
#line 4385 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 99: /* distinct ::= ALL */
#line 698 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[0].minor.yy144 = SF_All;}
#line 4390 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 101: /* sclp ::= */
...
#line 711 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[1].minor.yy14 = 0;}
#line 4400 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 102: /* selcollist ::= sclp scanpt expr scanpt as */
#line 712 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
   yymsp[-4].minor.yy14 = capdbExprListAppend(pParse, yymsp[-4].minor.yy14, yymsp[-2].minor.yy454);
   if( yymsp[0].minor.yy0.n>0 ) capdbExprListSetName(pParse, yymsp[-4].minor.yy14, &yymsp[0].minor.yy0, 1);
   capdbExprListSetSpan(pParse,yymsp[-4].minor.yy14,yymsp[-3].minor.yy168,yymsp[-1].minor.yy168);
}
#line 4409 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 103: /* selcollist ::= sclp scanpt STAR */
#line 717 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  Expr *p = capdbExpr(pParse->db, TK_ASTERISK, 0);
  capdbExprSetErrorOffset(p, (int)(yymsp[0].minor.yy0.z - pParse->zTail));
  yymsp[-2].minor.yy14 = capdbExprListAppend(pParse, yymsp[-2].minor.yy14, p);
}
#line 4418 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 104: /* selcollist ::= sclp scanpt nm DOT STAR */
#line 722 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  Expr *pRight, *pLeft, *pDot;
  pRight = capdbPExpr(pParse, TK_ASTERISK, 0, 0);
  capdbExprSetErrorOffset(pRight, (int)(yymsp[0].minor.yy0.z - pParse->zTail));
  pLeft = tokenExpr(pParse, TK_ID, yymsp[-2].minor.yy0);
  pDot = capdbPExpr(pParse, TK_DOT, pLeft, pRight);
  yymsp[-4].minor.yy14 = capdbExprListAppend(pParse,yymsp[-4].minor.yy14, pDot);
}
#line 4430 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 105: /* as ::= AS nm */
...
#line 735 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-1].minor.yy0 = yymsp[0].minor.yy0;}
#line 4438 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 107: /* from ::= */
      case 110: /* stl_prefix ::= */ yytestcase(yyruleno==110);
#line 749 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[1].minor.yy203 = 0;}
#line 4444 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 108: /* from ::= FROM seltablist */
#line 750 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-1].minor.yy203 = yymsp[0].minor.yy203;
  capdbSrcListShiftJoinType(pParse,yymsp[-1].minor.yy203);
}
#line 4452 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 109: /* stl_prefix ::= seltablist joinop */
#line 758 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
...
#line 4459 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 111: /* seltablist ::= stl_prefix nm dbnm as on_using */
#line 762 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-4].minor.yy203 = capdbSrcListAppendFromTerm(pParse,yymsp[-4].minor.yy203,&yymsp[-3].minor.yy0,&yymsp[-2].minor.yy0,&yymsp[-1].minor.yy0,0,&yymsp[0].minor.yy269);
}
#line 4466 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 112: /* seltablist ::= stl_prefix nm dbnm as indexed_by on_using */
#line 765 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-5].minor.yy203 = capdbSrcListAppendFromTerm(pParse,yymsp[-5].minor.yy203,&yymsp[-4].minor.yy0,&yymsp[-3].minor.yy0,&yymsp[-2].minor.yy0,0,&yymsp[0].minor.yy269);
  capdbSrcListIndexedBy(pParse, yymsp[-5].minor.yy203, &yymsp[-1].minor.yy0);
}
#line 4474 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 113: /* seltablist ::= stl_prefix nm dbnm LP exprlist RP as on_using */
#line 769 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-7].minor.yy203 = capdbSrcListAppendFromTerm(pParse,yymsp[-7].minor.yy203,&yymsp[-6].minor.yy0,&yymsp[-5].minor.yy0,&yymsp[-1].minor.yy0,0,&yymsp[0].minor.yy269);
  capdbSrcListFuncArgs(pParse, yymsp[-7].minor.yy203, yymsp[-3].minor.yy14);
}
#line 4482 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 114: /* seltablist ::= stl_prefix LP select RP as on_using */
#line 774 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
    yymsp[-5].minor.yy203 = capdbSrcListAppendFromTerm(pParse,yymsp[-5].minor.yy203,0,0,&yymsp[-1].minor.yy0,yymsp[-3].minor.yy555,&yymsp[0].minor.yy269);
  }
#line 4489 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 115: /* seltablist ::= stl_prefix LP seltablist RP as on_using */
#line 777 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
    if( yymsp[-5].minor.yy203==0 && yymsp[-1].minor.yy0.n==0 && yymsp[0].minor.yy269.pOn==0 && yymsp[0].minor.yy269.pUsing==0 ){
      ...
      yymsp[-5].minor.yy203 = capdbSrcListAppendFromTerm(pParse,yymsp[-5].minor.yy203,0,0,&yymsp[-1].minor.yy0,0,&yymsp[0].minor.yy269);
      ...
      capdbSrcListDelete(pParse->db, yymsp[-3].minor.yy203);
    }else{
      Select *pSubquery;
      capdbSrcListShiftJoinType(pParse,yymsp[-3].minor.yy203);
      pSubquery = capdbSelectNew(pParse,0,yymsp[-3].minor.yy203,0,0,0,0,SF_NestedFrom,0);
      yymsp[-5].minor.yy203 = capdbSrcListAppendFromTerm(pParse,yymsp[-5].minor.yy203,0,0,&yymsp[-1].minor.yy0,pSubquery,&yymsp[0].minor.yy269);
    }
  }
#line 4533 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 116: /* dbnm ::= */
      case 131: /* indexed_opt ::= */ yytestcase(yyruleno==131);
#line 820 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[1].minor.yy0.z=0; yymsp[1].minor.yy0.n=0;}
#line 4539 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 118: /* fullname ::= nm */
      case 120: /* xfullname ::= nm */ yytestcase(yyruleno==120);
#line 825 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yylhsminor.yy203 = capdbSrcListAppend(pParse,0,&yymsp[0].minor.yy0,0);
  if( IN_RENAME_OBJECT && yylhsminor.yy203 ) capdbRenameTokenMap(pParse, yylhsminor.yy203->a[0].zName, &yymsp[0].minor.yy0);
}
#line 4548 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[0].minor.yy203 = yylhsminor.yy203;
        break;
      case 119: /* fullname ::= nm DOT nm */
      case 121: /* xfullname ::= nm DOT nm */ yytestcase(yyruleno==121);
#line 829 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yylhsminor.yy203 = capdbSrcListAppend(pParse,0,&yymsp[-2].minor.yy0,&yymsp[0].minor.yy0);
  if( IN_RENAME_OBJECT && yylhsminor.yy203 ) capdbRenameTokenMap(pParse, yylhsminor.yy203->a[0].zName, &yymsp[0].minor.yy0);
}
#line 4558 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-2].minor.yy203 = yylhsminor.yy203;
        break;
      case 122: /* xfullname ::= nm AS nm */
#line 844 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yylhsminor.yy203 = capdbSrcListAppend(pParse,0,&yymsp[-2].minor.yy0,0);
  if( yylhsminor.yy203 ){
    if( IN_RENAME_OBJECT ){
      capdbRenameTokenMap(pParse, yylhsminor.yy203->a[0].zName, &yymsp[-2].minor.yy0);
    }else{
      yylhsminor.yy203->a[0].zAlias = capdbNameFromToken(pParse->db, &yymsp[0].minor.yy0);
    }
  }
}
#line 4573 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-2].minor.yy203 = yylhsminor.yy203;
        break;
      case 123: /* xfullname ::= nm DOT nm AS nm */
#line 854 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yylhsminor.yy203 = capdbSrcListAppend(pParse,0,&yymsp[-4].minor.yy0,&yymsp[-2].minor.yy0);
  if( yylhsminor.yy203 ){
    if( IN_RENAME_OBJECT ){
      capdbRenameTokenMap(pParse, yylhsminor.yy203->a[0].zName, &yymsp[-2].minor.yy0);
    }else{
...
#line 4588 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-4].minor.yy203 = yylhsminor.yy203;
        break;
      case 124: /* joinop ::= COMMA|JOIN */
#line 867 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[0].minor.yy144 = JT_INNER; }
#line 4594 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 125: /* joinop ::= JOIN_KW JOIN */
#line 869 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-1].minor.yy144 = capdbJoinType(pParse,&yymsp[-1].minor.yy0,0,0);  /*X-overwrites-A*/}
#line 4599 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 126: /* joinop ::= JOIN_KW nm JOIN */
#line 871 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-2].minor.yy144 = capdbJoinType(pParse,&yymsp[-2].minor.yy0,&yymsp[-1].minor.yy0,0); /*X-overwrites-A*/}
#line 4604 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 127: /* joinop ::= JOIN_KW nm nm JOIN */
#line 873 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-3].minor.yy144 = capdbJoinType(pParse,&yymsp[-3].minor.yy0,&yymsp[-2].minor.yy0,&yymsp[-1].minor.yy0);/*X-overwrites-A*/}
#line 4609 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 128: /* on_using ::= ON expr */
#line 894 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-1].minor.yy269.pOn = yymsp[0].minor.yy454; yymsp[-1].minor.yy269.pUsing = 0;}
#line 4614 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 129: /* on_using ::= USING LP idlist RP */
#line 895 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-3].minor.yy269.pOn = 0; yymsp[-3].minor.yy269.pUsing = yymsp[-1].minor.yy132;}
#line 4619 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 130: /* on_using ::= */
#line 896 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[1].minor.yy269.pOn = 0; yymsp[1].minor.yy269.pUsing = 0;}
#line 4624 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 132: /* indexed_by ::= INDEXED BY nm */
#line 912 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-2].minor.yy0 = yymsp[0].minor.yy0;}
#line 4629 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 133: /* indexed_by ::= NOT INDEXED */
#line 913 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-1].minor.yy0.z=0; yymsp[-1].minor.yy0.n=1;}
#line 4634 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 135: /* orderby_opt ::= ORDER BY sortlist */
      case 145: /* groupby_opt ::= GROUP BY nexprlist */ yytestcase(yyruleno==145);
#line 926 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-2].minor.yy14 = yymsp[0].minor.yy14;}
#line 4640 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 136: /* sortlist ::= sortlist COMMA expr sortorder nulls */
#line 927 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-4].minor.yy14 = capdbExprListAppend(pParse,yymsp[-4].minor.yy14,yymsp[-2].minor.yy454);
  capdbExprListSetSortOrder(yymsp[-4].minor.yy14,yymsp[-1].minor.yy144,yymsp[0].minor.yy144);
}
#line 4648 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 137: /* sortlist ::= expr sortorder nulls */
#line 931 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-2].minor.yy14 = capdbExprListAppend(pParse,0,yymsp[-2].minor.yy454); /*A-overwrites-Y*/
  capdbExprListSetSortOrder(yymsp[-2].minor.yy14,yymsp[-1].minor.yy144,yymsp[0].minor.yy144);
}
#line 4656 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 138: /* sortorder ::= ASC */
#line 938 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[0].minor.yy144 = CAPDB_SO_ASC;}
#line 4661 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 139: /* sortorder ::= DESC */
#line 939 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[0].minor.yy144 = CAPDB_SO_DESC;}
#line 4666 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 140: /* sortorder ::= */
      case 143: /* nulls ::= */ yytestcase(yyruleno==143);
#line 940 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[1].minor.yy144 = CAPDB_SO_UNDEFINED;}
#line 4672 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 141: /* nulls ::= NULLS FIRST */
#line 943 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-1].minor.yy144 = CAPDB_SO_ASC;}
#line 4677 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 142: /* nulls ::= NULLS LAST */
#line 944 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-1].minor.yy144 = CAPDB_SO_DESC;}
#line 4682 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 146: /* having_opt ::= */
...
#line 954 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[1].minor.yy454 = 0;}
#line 4693 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
...
#line 955 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-1].minor.yy454 = yymsp[0].minor.yy454;}
#line 4702 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 149: /* limit_opt ::= LIMIT expr */
#line 969 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-1].minor.yy454 = capdbPExpr(pParse,TK_LIMIT,yymsp[0].minor.yy454,0);}
#line 4707 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 150: /* limit_opt ::= LIMIT expr OFFSET expr */
#line 971 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-3].minor.yy454 = capdbPExpr(pParse,TK_LIMIT,yymsp[-2].minor.yy454,yymsp[0].minor.yy454);}
#line 4712 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 151: /* limit_opt ::= LIMIT expr COMMA expr */
#line 973 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-3].minor.yy454 = capdbPExpr(pParse,TK_LIMIT,yymsp[0].minor.yy454,yymsp[-2].minor.yy454);}
#line 4717 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 152: /* cmd ::= with DELETE FROM xfullname indexed_opt where_opt_ret */
#line 991 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbSrcListIndexedBy(pParse, yymsp[-2].minor.yy203, &yymsp[-1].minor.yy0);
  capdbDeleteFrom(pParse,yymsp[-2].minor.yy203,yymsp[0].minor.yy454,0,0);
}
#line 4725 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 157: /* where_opt_ret ::= RETURNING selcollist */
#line 1007 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbAddReturning(pParse,yymsp[0].minor.yy14); yymsp[-1].minor.yy454 = 0;}
#line 4730 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 158: /* where_opt_ret ::= WHERE expr RETURNING selcollist */
#line 1009 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbAddReturning(pParse,yymsp[0].minor.yy14); yymsp[-3].minor.yy454 = yymsp[-2].minor.yy454;}
#line 4735 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 159: /* cmd ::= with UPDATE orconf xfullname indexed_opt SET setlist from where_opt_ret */
#line 1041 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbSrcListIndexedBy(pParse, yymsp[-5].minor.yy203, &yymsp[-4].minor.yy0);
  capdbExprListCheckLength(pParse,yymsp[-2].minor.yy14,"set list"); 
  if( yymsp[-1].minor.yy203 ){
    ...
    yymsp[-5].minor.yy203 = capdbSrcListAppendList(pParse, yymsp[-5].minor.yy203, pFromClause);
  }
  capdbUpdate(pParse,yymsp[-5].minor.yy203,yymsp[-2].minor.yy14,yymsp[0].minor.yy454,yymsp[-6].minor.yy144,0,0,0);
}
#line 4756 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 160: /* setlist ::= setlist COMMA nm EQ expr */
#line 1065 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-4].minor.yy14 = capdbExprListAppend(pParse, yymsp[-4].minor.yy14, yymsp[0].minor.yy454);
  capdbExprListSetName(pParse, yymsp[-4].minor.yy14, &yymsp[-2].minor.yy0, 1);
}
#line 4764 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 161: /* setlist ::= setlist COMMA LP idlist RP EQ expr */
#line 1069 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-6].minor.yy14 = capdbExprListAppendVector(pParse, yymsp[-6].minor.yy14, yymsp[-3].minor.yy132, yymsp[0].minor.yy454);
}
#line 4771 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 162: /* setlist ::= nm EQ expr */
#line 1072 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yylhsminor.yy14 = capdbExprListAppend(pParse, 0, yymsp[0].minor.yy454);
  capdbExprListSetName(pParse, yylhsminor.yy14, &yymsp[-2].minor.yy0, 1);
}
#line 4779 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-2].minor.yy14 = yylhsminor.yy14;
        break;
      case 163: /* setlist ::= LP idlist RP EQ expr */
#line 1076 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-4].minor.yy14 = capdbExprListAppendVector(pParse, 0, yymsp[-3].minor.yy132, yymsp[0].minor.yy454);
}
#line 4787 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 164: /* cmd ::= with insert_cmd INTO xfullname idlist_opt select upsert */
#line 1083 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbInsert(pParse, yymsp[-3].minor.yy203, yymsp[-1].minor.yy555, yymsp[-2].minor.yy132, yymsp[-5].minor.yy144, yymsp[0].minor.yy122);
}
#line 4794 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 165: /* cmd ::= with insert_cmd INTO xfullname idlist_opt DEFAULT VALUES returning */
#line 1087 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbInsert(pParse, yymsp[-4].minor.yy203, 0, yymsp[-3].minor.yy132, yymsp[-6].minor.yy144, 0);
}
#line 4801 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 166: /* upsert ::= */
#line 1098 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[1].minor.yy122 = 0; }
#line 4806 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 167: /* upsert ::= RETURNING selcollist */
#line 1099 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[-1].minor.yy122 = 0; capdbAddReturning(pParse,yymsp[0].minor.yy14); }
#line 4811 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 168: /* upsert ::= ON CONFLICT LP sortlist RP where_opt DO UPDATE SET setlist where_opt upsert */
#line 1102 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[-11].minor.yy122 = capdbUpsertNew(pParse->db,yymsp[-8].minor.yy14,yymsp[-6].minor.yy454,yymsp[-2].minor.yy14,yymsp[-1].minor.yy454,yymsp[0].minor.yy122);}
#line 4816 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 169: /* upsert ::= ON CONFLICT LP sortlist RP where_opt DO NOTHING upsert */
#line 1104 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[-8].minor.yy122 = capdbUpsertNew(pParse->db,yymsp[-5].minor.yy14,yymsp[-3].minor.yy454,0,0,yymsp[0].minor.yy122); }
#line 4821 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 170: /* upsert ::= ON CONFLICT DO NOTHING returning */
#line 1106 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[-4].minor.yy122 = capdbUpsertNew(pParse->db,0,0,0,0,0); }
#line 4826 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 171: /* upsert ::= ON CONFLICT DO UPDATE SET setlist where_opt returning */
#line 1108 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[-7].minor.yy122 = capdbUpsertNew(pParse->db,0,0,yymsp[-2].minor.yy14,yymsp[-1].minor.yy454,0);}
#line 4831 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 172: /* returning ::= RETURNING selcollist */
#line 1110 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbAddReturning(pParse,yymsp[0].minor.yy14);}
#line 4836 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 175: /* idlist_opt ::= */
#line 1122 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[1].minor.yy132 = 0;}
#line 4841 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 176: /* idlist_opt ::= LP idlist RP */
#line 1123 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-2].minor.yy132 = yymsp[-1].minor.yy132;}
#line 4846 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 177: /* idlist ::= idlist COMMA nm */
#line 1125 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-2].minor.yy132 = capdbIdListAppend(pParse,yymsp[-2].minor.yy132,&yymsp[0].minor.yy0);}
#line 4851 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 178: /* idlist ::= nm */
#line 1127 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[0].minor.yy132 = capdbIdListAppend(pParse,0,&yymsp[0].minor.yy0); /*A-overwrites-Y*/}
#line 4856 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 179: /* expr ::= LP expr RP */
#line 1176 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-2].minor.yy454 = yymsp[-1].minor.yy454;}
#line 4861 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 180: /* expr ::= ID|INDEXED|JOIN_KW */
#line 1177 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[0].minor.yy454=tokenExpr(pParse,TK_ID,yymsp[0].minor.yy0); /*A-overwrites-X*/}
#line 4866 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 181: /* expr ::= nm DOT nm */
#line 1178 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  Expr *temp1 = tokenExpr(pParse,TK_ID,yymsp[-2].minor.yy0);
  Expr *temp2 = tokenExpr(pParse,TK_ID,yymsp[0].minor.yy0);
  yylhsminor.yy454 = capdbPExpr(pParse, TK_DOT, temp1, temp2);
}
#line 4875 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-2].minor.yy454 = yylhsminor.yy454;
        break;
      case 182: /* expr ::= nm DOT nm DOT nm */
#line 1183 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  ...
  yylhsminor.yy454 = capdbPExpr(pParse, TK_DOT, temp1, temp4);
}
#line 4890 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-4].minor.yy454 = yylhsminor.yy454;
        break;
      case 183: /* term ::= NULL|FLOAT|BLOB */
      case 184: /* term ::= STRING */ yytestcase(yyruleno==184);
#line 1193 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[0].minor.yy454=tokenExpr(pParse,yymsp[0].major,yymsp[0].minor.yy0); /*A-overwrites-X*/}
#line 4897 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 185: /* term ::= INTEGER */
#line 1195 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  int iValue;
  if( capdbGetInt32(yymsp[0].minor.yy0.z, &iValue)==0 ){
    yylhsminor.yy454 = capdbExprAlloc(pParse->db, TK_INTEGER, &yymsp[0].minor.yy0, 0);
  }else{
    yylhsminor.yy454 = capdbExprInt32(pParse->db, iValue);
  }
  if( yylhsminor.yy454 ) yylhsminor.yy454->w.iOfst = (int)(yymsp[0].minor.yy0.z - pParse->zTail);
}
#line 4910 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[0].minor.yy454 = yylhsminor.yy454;
        break;
      case 186: /* expr ::= VARIABLE */
#line 1204 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  if( !(yymsp[0].minor.yy0.z[0]=='#' && capdbIsdigit(yymsp[0].minor.yy0.z[1])) ){
    u32 n = yymsp[0].minor.yy0.n;
    yymsp[0].minor.yy454 = tokenExpr(pParse, TK_VARIABLE, yymsp[0].minor.yy0);
    capdbExprAssignVarNumber(pParse, yymsp[0].minor.yy454, n);
  }else{
    ...
    ** in the virtual machine.  #N is the N-th register. */
    ...
    if( pParse->nested==0 ){
      ...
      yymsp[0].minor.yy454 = capdbPExpr(pParse, TK_REGISTER, 0, 0);
      if( yymsp[0].minor.yy454 ) capdbGetInt32(&t.z[1], &yymsp[0].minor.yy454->iTable);
    }
  }
}
#line 4935 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 187: /* expr ::= expr COLLATE ID|STRING */
#line 1224 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-2].minor.yy454 = capdbExprAddCollateToken(pParse, yymsp[-2].minor.yy454, &yymsp[0].minor.yy0, 1);
}
#line 4942 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 188: /* expr ::= CAST LP expr AS typetoken RP */
#line 1228 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-5].minor.yy454 = capdbExprAlloc(pParse->db, TK_CAST, &yymsp[-1].minor.yy0, 1);
  capdbExprAttachSubtrees(pParse->db, yymsp[-5].minor.yy454, yymsp[-3].minor.yy454, 0);
}
#line 4950 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 189: /* expr ::= ID|INDEXED|JOIN_KW LP distinct exprlist RP */
#line 1235 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yylhsminor.yy454 = capdbExprFunction(pParse, yymsp[-1].minor.yy14, &yymsp[-4].minor.yy0, yymsp[-2].minor.yy144);
}
#line 4957 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-4].minor.yy454 = yylhsminor.yy454;
        break;
      case 190: /* expr ::= ID|INDEXED|JOIN_KW LP distinct exprlist ORDER BY sortlist RP */
#line 1238 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yylhsminor.yy454 = capdbExprFunction(pParse, yymsp[-4].minor.yy14, &yymsp[-7].minor.yy0, yymsp[-5].minor.yy144);
  capdbExprAddFunctionOrderBy(pParse, yylhsminor.yy454, yymsp[-1].minor.yy14);
}
#line 4966 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-7].minor.yy454 = yylhsminor.yy454;
        break;
      case 191: /* expr ::= ID|INDEXED|JOIN_KW LP STAR RP */
#line 1242 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yylhsminor.yy454 = capdbExprFunction(pParse, 0, &yymsp[-3].minor.yy0, 0);
}
#line 4974 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-3].minor.yy454 = yylhsminor.yy454;
        break;
      case 192: /* expr ::= ID|INDEXED|JOIN_KW LP distinct exprlist RP filter_over */
#line 1306 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yylhsminor.yy454 = capdbExprFunction(pParse, yymsp[-2].minor.yy14, &yymsp[-5].minor.yy0, yymsp[-3].minor.yy144);
  capdbWindowAttach(pParse, yylhsminor.yy454, yymsp[0].minor.yy211);
}
#line 4983 "/home/megalith/CapperVM/CapDB/core/parse.c"
...
#line 1310 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yylhsminor.yy454 = capdbExprFunction(pParse, yymsp[-5].minor.yy14, &yymsp[-8].minor.yy0, yymsp[-6].minor.yy144);
  capdbWindowAttach(pParse, yylhsminor.yy454, yymsp[0].minor.yy211);
  capdbExprAddFunctionOrderBy(pParse, yylhsminor.yy454, yymsp[-2].minor.yy14);
}
#line 4993 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-8].minor.yy454 = yylhsminor.yy454;
        break;
      case 194: /* expr ::= ID|INDEXED|JOIN_KW LP STAR RP filter_over */
#line 1315 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yylhsminor.yy454 = capdbExprFunction(pParse, 0, &yymsp[-4].minor.yy0, 0);
  capdbWindowAttach(pParse, yylhsminor.yy454, yymsp[0].minor.yy211);
}
#line 5002 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-4].minor.yy454 = yylhsminor.yy454;
        break;
      case 195: /* term ::= CTIME_KW */
#line 1329 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yylhsminor.yy454 = capdbExprFunction(pParse, 0, &yymsp[0].minor.yy0, 0);
}
#line 5010 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[0].minor.yy454 = yylhsminor.yy454;
        break;
      case 196: /* expr ::= LP nexprlist COMMA expr RP */
#line 1333 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  ExprList *pList = capdbExprListAppend(pParse, yymsp[-3].minor.yy14, yymsp[-1].minor.yy454);
  yymsp[-4].minor.yy454 = capdbPExpr(pParse, TK_VECTOR, 0, 0);
...
#line 5029 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 197: /* expr ::= expr AND expr */
#line 1348 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-2].minor.yy454=capdbExprAnd(pParse,yymsp[-2].minor.yy454,yymsp[0].minor.yy454);}
#line 5034 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
...
#line 1349 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-2].minor.yy454=capdbPExpr(pParse,yymsp[-1].major,yymsp[-2].minor.yy454,yymsp[0].minor.yy454);}
#line 5045 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 205: /* likeop ::= NOT LIKE_KW|MATCH */
#line 1362 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-1].minor.yy0=yymsp[0].minor.yy0; yymsp[-1].minor.yy0.n|=0x80000000; /*yymsp[-1].minor.yy0-overwrite-yymsp[0].minor.yy0*/}
#line 5050 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 206: /* expr ::= expr likeop expr */
#line 1363 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  ExprList *pList;
  int bNot = yymsp[-1].minor.yy0.n & 0x80000000;
  yymsp[-1].minor.yy0.n &= 0x7fffffff;
  pList = capdbExprListAppend(pParse,0, yymsp[0].minor.yy454);
  pList = capdbExprListAppend(pParse,pList, yymsp[-2].minor.yy454);
  yymsp[-2].minor.yy454 = capdbExprFunction(pParse, pList, &yymsp[-1].minor.yy0, 0);
  if( bNot ) yymsp[-2].minor.yy454 = capdbPExpr(pParse, TK_NOT, yymsp[-2].minor.yy454, 0);
  if( yymsp[-2].minor.yy454 ) yymsp[-2].minor.yy454->flags |= EP_InfixFunc;
}
#line 5064 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 207: /* expr ::= expr likeop expr ESCAPE expr */
#line 1373 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  ExprList *pList;
  int bNot = yymsp[-3].minor.yy0.n & 0x80000000;
  yymsp[-3].minor.yy0.n &= 0x7fffffff;
  pList = capdbExprListAppend(pParse,0, yymsp[-2].minor.yy454);
  pList = capdbExprListAppend(pParse,pList, yymsp[-4].minor.yy454);
  pList = capdbExprListAppend(pParse,pList, yymsp[0].minor.yy454);
  yymsp[-4].minor.yy454 = capdbExprFunction(pParse, pList, &yymsp[-3].minor.yy0, 0);
  if( bNot ) yymsp[-4].minor.yy454 = capdbPExpr(pParse, TK_NOT, yymsp[-4].minor.yy454, 0);
  if( yymsp[-4].minor.yy454 ) yymsp[-4].minor.yy454->flags |= EP_InfixFunc;
}
#line 5079 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 208: /* expr ::= expr ISNULL|NOTNULL */
#line 1429 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-1].minor.yy454 = capdbPExprIsNull(pParse,yymsp[0].major,yymsp[-1].minor.yy454);}
#line 5084 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 209: /* expr ::= expr NOT NULL */
#line 1430 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-2].minor.yy454 = capdbPExprIsNull(pParse,TK_NOTNULL,yymsp[-2].minor.yy454);}
#line 5089 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 210: /* expr ::= expr IS expr */
#line 1435 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-2].minor.yy454 = capdbPExprIs(pParse, TK_IS, yymsp[-2].minor.yy454, yymsp[0].minor.yy454);
}
#line 5096 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 211: /* expr ::= expr IS NOT expr */
#line 1438 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-3].minor.yy454 = capdbPExprIs(pParse, TK_ISNOT, yymsp[-3].minor.yy454, yymsp[0].minor.yy454);
}
#line 5103 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 212: /* expr ::= expr IS NOT DISTINCT FROM expr */
#line 1441 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-5].minor.yy454 = capdbPExprIs(pParse, TK_IS, yymsp[-5].minor.yy454, yymsp[0].minor.yy454);
}
#line 5110 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 213: /* expr ::= expr IS DISTINCT FROM expr */
#line 1444 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-4].minor.yy454 = capdbPExprIs(pParse, TK_ISNOT, yymsp[-4].minor.yy454, yymsp[0].minor.yy454);
}
#line 5117 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 214: /* expr ::= NOT expr */
      case 215: /* expr ::= BITNOT expr */ yytestcase(yyruleno==215);
#line 1449 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-1].minor.yy454 = capdbPExpr(pParse, yymsp[-1].major, yymsp[0].minor.yy454, 0);/*A-overwrites-B*/}
#line 5123 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 216: /* expr ::= PLUS|MINUS expr */
#line 1452 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  ...
  if( p && p->op==TK_UPLUS ){
    ...
    yymsp[-1].minor.yy454 = capdbPExpr(pParse, op, p, 0);
    /*A-overwrites-B*/
  }
}
#line 5140 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 217: /* expr ::= expr PTR expr */
#line 1466 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  ExprList *pList = capdbExprListAppend(pParse, 0, yymsp[-2].minor.yy454);
  pList = capdbExprListAppend(pParse, pList, yymsp[0].minor.yy454);
  yylhsminor.yy454 = capdbExprFunction(pParse, pList, &yymsp[-1].minor.yy0, 0);
}
#line 5149 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-2].minor.yy454 = yylhsminor.yy454;
        break;
      case 218: /* between_op ::= BETWEEN */
      case 221: /* in_op ::= IN */ yytestcase(yyruleno==221);
#line 1473 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[0].minor.yy144 = 0;}
#line 5156 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 220: /* expr ::= expr between_op expr AND expr */
#line 1475 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  ExprList *pList = capdbExprListAppend(pParse,0, yymsp[-2].minor.yy454);
  pList = capdbExprListAppend(pParse,pList, yymsp[0].minor.yy454);
  yymsp[-4].minor.yy454 = capdbPExpr(pParse, TK_BETWEEN, yymsp[-4].minor.yy454, 0);
  if( yymsp[-4].minor.yy454 ){
    yymsp[-4].minor.yy454->x.pList = pList;
    capdbExprSetHeightAndFlags(pParse, yymsp[-4].minor.yy454);
  }else{
    capdbExprListDelete(pParse->db, pList);
  } 
  if( yymsp[-3].minor.yy144 ) yymsp[-4].minor.yy454 = capdbPExpr(pParse, TK_NOT, yymsp[-4].minor.yy454, 0);
}
#line 5172 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 223: /* expr ::= expr in_op LP exprlist RP */
#line 1491 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
    if( yymsp[-1].minor.yy14==0 ){
      ...
      ** of the whole query.
      */
      Expr *pB = capdbExpr(pParse->db, TK_STRING, yymsp[-3].minor.yy144 ? "true" : "false");
      if( pB ) capdbExprIdToTrueFalse(pB);
      if( !ExprHasProperty(yymsp[-4].minor.yy454, EP_HasFunc) ){
        capdbExprUnmapAndDelete(pParse, yymsp[-4].minor.yy454);
        yymsp[-4].minor.yy454 = pB;
      }else{
        yymsp[-4].minor.yy454 = capdbPExpr(pParse, yymsp[-3].minor.yy144 ? TK_OR : TK_AND, pB, yymsp[-4].minor.yy454);
      }
    }else{
      Expr *pRHS = yymsp[-1].minor.yy14->a[0].pExpr;
      if( yymsp[-1].minor.yy14->nExpr==1 && capdbExprIsConstant(pParse,pRHS) && yymsp[-4].minor.yy454->op!=TK_VECTOR ){
        yymsp[-1].minor.yy14->a[0].pExpr = 0;
        capdbExprListDelete(pParse->db, yymsp[-1].minor.yy14);
        pRHS = capdbPExpr(pParse, TK_UPLUS, pRHS, 0);
        yymsp[-4].minor.yy454 = capdbPExpr(pParse, TK_EQ, yymsp[-4].minor.yy454, pRHS);
      }else if( yymsp[-1].minor.yy14->nExpr==1 && pRHS->op==TK_SELECT ){
        yymsp[-4].minor.yy454 = capdbPExpr(pParse, TK_IN, yymsp[-4].minor.yy454, 0);
        capdbPExprAddSelect(pParse, yymsp[-4].minor.yy454, pRHS->x.pSelect);
        pRHS->x.pSelect = 0;
        capdbExprListDelete(pParse->db, yymsp[-1].minor.yy14);
      }else{
        yymsp[-4].minor.yy454 = capdbPExpr(pParse, TK_IN, yymsp[-4].minor.yy454, 0);
        if( yymsp[-4].minor.yy454==0 ){
          ...
          Select *pSelectRHS = capdbExprListToValues(pParse, nExpr, yymsp[-1].minor.yy14);
          if( pSelectRHS ){
            parserDoubleLinkSelect(pParse, pSelectRHS);
            capdbPExprAddSelect(pParse, yymsp[-4].minor.yy454, pSelectRHS);
          }
        }else{
...
#line 5229 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 224: /* expr ::= LP select RP */
#line 1544 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
    yymsp[-2].minor.yy454 = capdbPExpr(pParse, TK_SELECT, 0, 0);
    capdbPExprAddSelect(pParse, yymsp[-2].minor.yy454, yymsp[-1].minor.yy555);
  }
#line 5237 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 225: /* expr ::= expr in_op LP select RP */
#line 1548 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
    yymsp[-4].minor.yy454 = capdbPExpr(pParse, TK_IN, yymsp[-4].minor.yy454, 0);
    capdbPExprAddSelect(pParse, yymsp[-4].minor.yy454, yymsp[-1].minor.yy555);
    if( yymsp[-3].minor.yy144 ) yymsp[-4].minor.yy454 = capdbPExpr(pParse, TK_NOT, yymsp[-4].minor.yy454, 0);
  }
#line 5246 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 226: /* expr ::= expr in_op nm dbnm paren_exprlist */
#line 1553 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
    SrcList *pSrc = capdbSrcListAppend(pParse, 0,&yymsp[-2].minor.yy0,&yymsp[-1].minor.yy0);
    Select *pSelect = capdbSelectNew(pParse, 0,pSrc,0,0,0,0,0,0);
    if( yymsp[0].minor.yy14 )  capdbSrcListFuncArgs(pParse, pSelect ? pSrc : 0, yymsp[0].minor.yy14);
    yymsp[-4].minor.yy454 = capdbPExpr(pParse, TK_IN, yymsp[-4].minor.yy454, 0);
    capdbPExprAddSelect(pParse, yymsp[-4].minor.yy454, pSelect);
    if( yymsp[-3].minor.yy144 ) yymsp[-4].minor.yy454 = capdbPExpr(pParse, TK_NOT, yymsp[-4].minor.yy454, 0);
  }
#line 5258 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 227: /* expr ::= EXISTS LP select RP */
#line 1561 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
    Expr *p;
    p = yymsp[-3].minor.yy454 = capdbPExpr(pParse, TK_EXISTS, 0, 0);
    capdbPExprAddSelect(pParse, p, yymsp[-1].minor.yy555);
  }
#line 5267 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 228: /* expr ::= CASE case_operand case_exprlist case_else END */
#line 1569 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-4].minor.yy454 = capdbPExpr(pParse, TK_CASE, yymsp[-3].minor.yy454, 0);
  if( yymsp[-4].minor.yy454 ){
    yymsp[-4].minor.yy454->x.pList = yymsp[-1].minor.yy454 ? capdbExprListAppend(pParse,yymsp[-2].minor.yy14,yymsp[-1].minor.yy454) : yymsp[-2].minor.yy14;
    capdbExprSetHeightAndFlags(pParse, yymsp[-4].minor.yy454);
  }else{
    capdbExprListDelete(pParse->db, yymsp[-2].minor.yy14);
    capdbExprDelete(pParse->db, yymsp[-1].minor.yy454);
  }
}
#line 5281 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 229: /* case_exprlist ::= case_exprlist WHEN expr THEN expr */
#line 1581 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-4].minor.yy14 = capdbExprListAppend(pParse,yymsp[-4].minor.yy14, yymsp[-2].minor.yy454);
  yymsp[-4].minor.yy14 = capdbExprListAppend(pParse,yymsp[-4].minor.yy14, yymsp[0].minor.yy454);
}
#line 5289 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 230: /* case_exprlist ::= WHEN expr THEN expr */
#line 1585 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-3].minor.yy14 = capdbExprListAppend(pParse,0, yymsp[-2].minor.yy454);
  yymsp[-3].minor.yy14 = capdbExprListAppend(pParse,yymsp[-3].minor.yy14, yymsp[0].minor.yy454);
}
#line 5297 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 235: /* nexprlist ::= nexprlist COMMA expr */
#line 1606 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-2].minor.yy14 = capdbExprListAppend(pParse,yymsp[-2].minor.yy14,yymsp[0].minor.yy454);}
#line 5302 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 236: /* nexprlist ::= expr */
#line 1608 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[0].minor.yy14 = capdbExprListAppend(pParse,0,yymsp[0].minor.yy454); /*A-overwrites-Y*/}
#line 5307 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 238: /* paren_exprlist ::= LP exprlist RP */
      case 243: /* eidlist_opt ::= LP eidlist RP */ yytestcase(yyruleno==243);
#line 1616 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-2].minor.yy14 = yymsp[-1].minor.yy14;}
#line 5313 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 239: /* cmd ::= createkw uniqueflag INDEX ifnotexists nm dbnm ON nm LP sortlist RP where_opt */
#line 1623 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbCreateIndex(pParse, &yymsp[-7].minor.yy0, &yymsp[-6].minor.yy0, 
                     capdbSrcListAppend(pParse,0,&yymsp[-4].minor.yy0,0), yymsp[-2].minor.yy14, yymsp[-10].minor.yy144,
                      &yymsp[-11].minor.yy0, yymsp[0].minor.yy454, CAPDB_SO_ASC, yymsp[-8].minor.yy144, CAPDB_IDXTYPE_APPDEF);
  if( IN_RENAME_OBJECT && pParse->pNewIndex ){
    capdbRenameTokenMap(pParse, pParse->pNewIndex->zName, &yymsp[-4].minor.yy0);
  }
}
#line 5325 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 240: /* uniqueflag ::= UNIQUE */
      case 281: /* raisetype ::= ABORT */ yytestcase(yyruleno==281);
#line 1633 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[0].minor.yy144 = OE_Abort;}
#line 5331 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 241: /* uniqueflag ::= */
#line 1634 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[1].minor.yy144 = OE_None;}
#line 5336 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 244: /* eidlist ::= eidlist COMMA nm collate sortorder */
#line 1684 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
...
#line 5343 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 245: /* eidlist ::= nm collate sortorder */
#line 1687 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
...
#line 5350 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 248: /* cmd ::= DROP INDEX ifexists fullname */
#line 1698 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbDropIndex(pParse, yymsp[0].minor.yy203, yymsp[-1].minor.yy144);}
#line 5355 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 249: /* cmd ::= VACUUM vinto */
#line 1705 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbVacuum(pParse,0,yymsp[0].minor.yy454);}
#line 5360 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 250: /* cmd ::= VACUUM nm vinto */
#line 1706 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbVacuum(pParse,&yymsp[-1].minor.yy0,yymsp[0].minor.yy454);}
#line 5365 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 253: /* cmd ::= PRAGMA nm dbnm */
#line 1714 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbPragma(pParse,&yymsp[-1].minor.yy0,&yymsp[0].minor.yy0,0,0);}
#line 5370 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 254: /* cmd ::= PRAGMA nm dbnm EQ nmnum */
#line 1715 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbPragma(pParse,&yymsp[-3].minor.yy0,&yymsp[-2].minor.yy0,&yymsp[0].minor.yy0,0);}
#line 5375 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 255: /* cmd ::= PRAGMA nm dbnm LP nmnum RP */
#line 1716 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbPragma(pParse,&yymsp[-4].minor.yy0,&yymsp[-3].minor.yy0,&yymsp[-1].minor.yy0,0);}
#line 5380 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 256: /* cmd ::= PRAGMA nm dbnm EQ minus_num */
#line 1718 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbPragma(pParse,&yymsp[-3].minor.yy0,&yymsp[-2].minor.yy0,&yymsp[0].minor.yy0,1);}
#line 5385 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 257: /* cmd ::= PRAGMA nm dbnm LP minus_num RP */
#line 1720 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbPragma(pParse,&yymsp[-4].minor.yy0,&yymsp[-3].minor.yy0,&yymsp[-1].minor.yy0,1);}
#line 5390 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 260: /* cmd ::= createkw trigger_decl BEGIN trigger_cmd_list END */
#line 1736 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  Token all;
  all.z = yymsp[-3].minor.yy0.z;
  all.n = (int)(yymsp[0].minor.yy0.z - yymsp[-3].minor.yy0.z) + yymsp[0].minor.yy0.n;
  capdbFinishTrigger(pParse, yymsp[-1].minor.yy427, &all);
}
#line 5400 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 261: /* trigger_decl ::= temp TRIGGER ifnotexists nm dbnm trigger_time trigger_event ON fullname foreach_clause when_clause */
#line 1745 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbBeginTrigger(pParse, &yymsp[-7].minor.yy0, &yymsp[-6].minor.yy0, yymsp[-5].minor.yy144, yymsp[-4].minor.yy286.a, yymsp[-4].minor.yy286.b, yymsp[-2].minor.yy203, yymsp[0].minor.yy454, yymsp[-10].minor.yy144, yymsp[-8].minor.yy144);
...
#line 5412 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 262: /* trigger_time ::= BEFORE|AFTER */
#line 1755 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[0].minor.yy144 = yymsp[0].major; /*A-overwrites-X*/ }
#line 5417 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 263: /* trigger_time ::= INSTEAD OF */
#line 1756 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[-1].minor.yy144 = TK_INSTEAD;}
#line 5422 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 264: /* trigger_time ::= */
#line 1757 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[1].minor.yy144 = TK_BEFORE; }
#line 5427 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 265: /* trigger_event ::= DELETE|INSERT */
      case 266: /* trigger_event ::= UPDATE */ yytestcase(yyruleno==266);
#line 1761 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[0].minor.yy286.a = yymsp[0].major; /*A-overwrites-X*/ yymsp[0].minor.yy286.b = 0;}
#line 5433 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 267: /* trigger_event ::= UPDATE OF idlist */
#line 1763 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-2].minor.yy286.a = TK_UPDATE; yymsp[-2].minor.yy286.b = yymsp[0].minor.yy132;}
#line 5438 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 268: /* when_clause ::= */
      case 286: /* key_opt ::= */ yytestcase(yyruleno==286);
#line 1770 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[1].minor.yy454 = 0; }
#line 5444 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 269: /* when_clause ::= WHEN expr */
      case 287: /* key_opt ::= KEY expr */ yytestcase(yyruleno==287);
#line 1771 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[-1].minor.yy454 = yymsp[0].minor.yy454; }
#line 5450 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 270: /* trigger_cmd_list ::= trigger_cmd_list trigger_cmd SEMI */
#line 1775 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-2].minor.yy427->pLast->pNext = yymsp[-1].minor.yy427;
  yymsp[-2].minor.yy427->pLast = yymsp[-1].minor.yy427;
}
#line 5458 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 271: /* trigger_cmd_list ::= trigger_cmd SEMI */
#line 1779 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ 
  yymsp[-1].minor.yy427->pLast = yymsp[-1].minor.yy427;
}
#line 5465 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 272: /* tridxby ::= INDEXED BY nm */
#line 1788 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbErrorMsg(pParse,
        "the INDEXED BY clause is not allowed on UPDATE or DELETE statements "
        "within triggers");
}
#line 5474 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 273: /* tridxby ::= NOT INDEXED */
#line 1793 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbErrorMsg(pParse,
        "the NOT INDEXED clause is not allowed on UPDATE or DELETE statements "
        "within triggers");
}
#line 5483 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 274: /* trigger_cmd ::= UPDATE orconf xfullname tridxby SET setlist from where_opt scanpt */
#line 1806 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yylhsminor.yy427 = capdbTriggerUpdateStep(pParse, yymsp[-6].minor.yy203, yymsp[-2].minor.yy203, yymsp[-3].minor.yy14, yymsp[-1].minor.yy454, yymsp[-7].minor.yy144, yymsp[-8].minor.yy0.z, yymsp[0].minor.yy168);}
#line 5488 "/home/megalith/CapperVM/CapDB/core/parse.c"
...
#line 1810 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
   yylhsminor.yy427 = capdbTriggerInsertStep(pParse,yymsp[-4].minor.yy203,yymsp[-3].minor.yy132,yymsp[-2].minor.yy555,yymsp[-6].minor.yy144,yymsp[-1].minor.yy122,yymsp[-7].minor.yy168,yymsp[0].minor.yy168);/*yylhsminor.yy427-overwrites-yymsp[-6].minor.yy144*/
}
#line 5496 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-7].minor.yy427 = yylhsminor.yy427;
        break;
      case 276: /* trigger_cmd ::= DELETE FROM xfullname tridxby where_opt scanpt */
#line 1815 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yylhsminor.yy427 = capdbTriggerDeleteStep(pParse, yymsp[-3].minor.yy203, yymsp[-1].minor.yy454, yymsp[-5].minor.yy0.z, yymsp[0].minor.yy168);}
#line 5502 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-5].minor.yy427 = yylhsminor.yy427;
        break;
      case 277: /* trigger_cmd ::= scanpt select scanpt */
#line 1819 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yylhsminor.yy427 = capdbTriggerSelectStep(pParse->db, yymsp[-1].minor.yy555, yymsp[-2].minor.yy168, yymsp[0].minor.yy168); /*yylhsminor.yy427-overwrites-yymsp[-1].minor.yy555*/}
#line 5508 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-2].minor.yy427 = yylhsminor.yy427;
        break;
      case 278: /* expr ::= RAISE LP IGNORE RP */
#line 1822 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-3].minor.yy454 = capdbPExpr(pParse, TK_RAISE, 0, 0); 
  if( yymsp[-3].minor.yy454 ){
    yymsp[-3].minor.yy454->affExpr = OE_Ignore;
  }
}
#line 5519 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 279: /* expr ::= RAISE LP raisetype COMMA expr RP */
#line 1828 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-5].minor.yy454 = capdbPExpr(pParse, TK_RAISE, yymsp[-1].minor.yy454, 0);
  if( yymsp[-5].minor.yy454 ) {
    yymsp[-5].minor.yy454->affExpr = (char)yymsp[-3].minor.yy144;
  }
}
#line 5529 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 280: /* raisetype ::= ROLLBACK */
#line 1837 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[0].minor.yy144 = OE_Rollback;}
#line 5534 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 282: /* raisetype ::= FAIL */
#line 1839 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[0].minor.yy144 = OE_Fail;}
#line 5539 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 283: /* cmd ::= DROP TRIGGER ifexists fullname */
#line 1844 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbDropTrigger(pParse,yymsp[0].minor.yy203,yymsp[-1].minor.yy144);
}
#line 5546 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 284: /* cmd ::= ATTACH database_kw_opt expr AS expr key_opt */
#line 1851 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbAttach(pParse, yymsp[-3].minor.yy454, yymsp[-1].minor.yy454, yymsp[0].minor.yy454);
}
#line 5553 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 285: /* cmd ::= DETACH database_kw_opt expr */
#line 1854 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbDetach(pParse, yymsp[0].minor.yy454);
}
#line 5560 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 288: /* cmd ::= REINDEX */
#line 1869 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbReindex(pParse, 0, 0);}
#line 5565 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 289: /* cmd ::= REINDEX nm dbnm */
#line 1870 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbReindex(pParse, &yymsp[-1].minor.yy0, &yymsp[0].minor.yy0);}
#line 5570 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 290: /* cmd ::= ANALYZE */
#line 1875 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbAnalyze(pParse, 0, 0);}
#line 5575 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 291: /* cmd ::= ANALYZE nm dbnm */
#line 1876 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbAnalyze(pParse, &yymsp[-1].minor.yy0, &yymsp[0].minor.yy0);}
#line 5580 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 292: /* cmd ::= ALTER TABLE fullname RENAME TO nm */
#line 1882 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbAlterRenameTable(pParse,yymsp[-3].minor.yy203,&yymsp[0].minor.yy0);
}
#line 5587 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 293: /* cmd ::= alter_add carglist */
#line 1889 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-1].minor.yy0.n = (int)(pParse->sLastToken.z-yymsp[-1].minor.yy0.z) + pParse->sLastToken.n;
  capdbAlterFinishAddColumn(pParse, &yymsp[-1].minor.yy0);
}
#line 5595 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 294: /* alter_add ::= ALTER TABLE fullname ADD kwcolumn_opt nm typetoken */
#line 1893 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  disableLookaside(pParse);
  capdbAlterBeginAddColumn(pParse, yymsp[-4].minor.yy203);
  capdbAddColumn(pParse, yymsp[-1].minor.yy0, yymsp[0].minor.yy0);
  yymsp[-6].minor.yy0 = yymsp[-1].minor.yy0;
}
#line 5605 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 295: /* cmd ::= ALTER TABLE fullname DROP kwcolumn_opt nm */
#line 1900 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbAlterDropColumn(pParse, yymsp[-3].minor.yy203, &yymsp[0].minor.yy0);
}
#line 5612 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 296: /* cmd ::= ALTER TABLE fullname RENAME kwcolumn_opt nm TO nm */
#line 1903 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbAlterRenameColumn(pParse, yymsp[-5].minor.yy203, &yymsp[-2].minor.yy0, &yymsp[0].minor.yy0);
}
#line 5619 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 297: /* cmd ::= ALTER TABLE fullname DROP CONSTRAINT nm */
#line 1906 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbAlterDropConstraint(pParse, yymsp[-3].minor.yy203, &yymsp[0].minor.yy0, 0);
}
#line 5626 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 298: /* cmd ::= ALTER TABLE fullname ALTER kwcolumn_opt nm DROP NOT NULL */
#line 1909 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbAlterDropConstraint(pParse, yymsp[-6].minor.yy203, 0, &yymsp[-3].minor.yy0);
}
#line 5633 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 299: /* cmd ::= ALTER TABLE fullname ALTER kwcolumn_opt nm SET NOT NULL onconf */
#line 1912 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbAlterSetNotNull(pParse, yymsp[-7].minor.yy203, &yymsp[-4].minor.yy0, &yymsp[-2].minor.yy0);
}
#line 5640 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 300: /* cmd ::= ALTER TABLE fullname ADD CONSTRAINT nm CHECK LP expr RP onconf */
#line 1915 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbAlterAddConstraint(pParse, yymsp[-8].minor.yy203, &yymsp[-6].minor.yy0, &yymsp[-5].minor.yy0, yymsp[-3].minor.yy0.z+1, (yymsp[-1].minor.yy0.z-yymsp[-3].minor.yy0.z-1), yymsp[-2].minor.yy454);
}
#line 5647 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 301: /* cmd ::= ALTER TABLE fullname ADD CHECK LP expr RP onconf */
#line 1918 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  capdbAlterAddConstraint(pParse, yymsp[-6].minor.yy203, &yymsp[-4].minor.yy0, 0, yymsp[-3].minor.yy0.z+1, (yymsp[-1].minor.yy0.z-yymsp[-3].minor.yy0.z-1), yymsp[-2].minor.yy454);
}
#line 5654 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 302: /* cmd ::= create_vtab */
#line 1930 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbVtabFinishParse(pParse,0);}
#line 5659 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 303: /* cmd ::= create_vtab LP vtabarglist RP */
#line 1931 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbVtabFinishParse(pParse,&yymsp[0].minor.yy0);}
#line 5664 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 304: /* create_vtab ::= createkw VIRTUAL TABLE ifnotexists nm dbnm USING nm */
#line 1933 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
    capdbVtabBeginParse(pParse, &yymsp[-3].minor.yy0, &yymsp[-2].minor.yy0, &yymsp[0].minor.yy0, yymsp[-4].minor.yy144);
}
#line 5671 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 305: /* vtabarg ::= */
#line 1938 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbVtabArgInit(pParse);}
#line 5676 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
...
#line 1940 "/home/megalith/CapperVM/CapDB/core/parse.y"
{capdbVtabArgExtend(pParse,&yymsp[0].minor.yy0);}
#line 5683 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 309: /* with ::= WITH wqlist */
      case 310: /* with ::= WITH RECURSIVE wqlist */ yytestcase(yyruleno==310);
#line 1957 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ capdbWithPush(pParse, yymsp[0].minor.yy59, 1); }
#line 5689 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 311: /* wqas ::= AS */
#line 1961 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[0].minor.yy462 = M10d_Any;}
#line 5694 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 312: /* wqas ::= AS MATERIALIZED */
#line 1962 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-1].minor.yy462 = M10d_Yes;}
#line 5699 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 313: /* wqas ::= AS NOT MATERIALIZED */
#line 1963 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-2].minor.yy462 = M10d_No;}
#line 5704 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 314: /* wqitem ::= withnm eidlist_opt wqas LP select RP */
#line 1964 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-5].minor.yy67 = capdbCteNew(pParse, &yymsp[-5].minor.yy0, yymsp[-4].minor.yy14, yymsp[-1].minor.yy555, yymsp[-3].minor.yy462); /*A-overwrites-X*/
}
#line 5711 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 315: /* withnm ::= nm */
#line 1967 "/home/megalith/CapperVM/CapDB/core/parse.y"
{pParse->bHasWith = 1;}
#line 5716 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 316: /* wqlist ::= wqitem */
#line 1968 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[0].minor.yy59 = capdbWithAdd(pParse, 0, yymsp[0].minor.yy67); /*A-overwrites-X*/
}
#line 5723 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 317: /* wqlist ::= wqlist COMMA wqitem */
#line 1971 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-2].minor.yy59 = capdbWithAdd(pParse, yymsp[-2].minor.yy59, yymsp[0].minor.yy67);
}
#line 5730 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 318: /* windowdefn_list ::= windowdefn_list COMMA windowdefn */
#line 1987 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  assert( yymsp[0].minor.yy211!=0 );
  capdbWindowChain(pParse, yymsp[0].minor.yy211, yymsp[-2].minor.yy211);
  yymsp[0].minor.yy211->pNextWin = yymsp[-2].minor.yy211;
  yylhsminor.yy211 = yymsp[0].minor.yy211;
}
#line 5740 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-2].minor.yy211 = yylhsminor.yy211;
        break;
      case 319: /* windowdefn ::= nm AS LP window RP */
#line 1996 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  if( ALWAYS(yymsp[-1].minor.yy211) ){
    yymsp[-1].minor.yy211->zName = capdbDbStrNDup(pParse->db, yymsp[-4].minor.yy0.z, yymsp[-4].minor.yy0.n);
  }
  yylhsminor.yy211 = yymsp[-1].minor.yy211;
}
#line 5751 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-4].minor.yy211 = yylhsminor.yy211;
        break;
      case 320: /* window ::= PARTITION BY nexprlist orderby_opt frame_opt */
#line 2030 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-4].minor.yy211 = capdbWindowAssemble(pParse, yymsp[0].minor.yy211, yymsp[-2].minor.yy14, yymsp[-1].minor.yy14, 0);
}
#line 5759 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 321: /* window ::= nm PARTITION BY nexprlist orderby_opt frame_opt */
#line 2033 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yylhsminor.yy211 = capdbWindowAssemble(pParse, yymsp[0].minor.yy211, yymsp[-2].minor.yy14, yymsp[-1].minor.yy14, &yymsp[-5].minor.yy0);
}
#line 5766 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-5].minor.yy211 = yylhsminor.yy211;
        break;
      case 322: /* window ::= ORDER BY sortlist frame_opt */
#line 2036 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-3].minor.yy211 = capdbWindowAssemble(pParse, yymsp[0].minor.yy211, 0, yymsp[-1].minor.yy14, 0);
}
#line 5774 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 323: /* window ::= nm ORDER BY sortlist frame_opt */
#line 2039 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yylhsminor.yy211 = capdbWindowAssemble(pParse, yymsp[0].minor.yy211, 0, yymsp[-1].minor.yy14, &yymsp[-4].minor.yy0);
}
#line 5781 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-4].minor.yy211 = yylhsminor.yy211;
        break;
      case 324: /* window ::= nm frame_opt */
#line 2043 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yylhsminor.yy211 = capdbWindowAssemble(pParse, yymsp[0].minor.yy211, 0, 0, &yymsp[-1].minor.yy0);
}
#line 5789 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-1].minor.yy211 = yylhsminor.yy211;
        break;
      case 325: /* frame_opt ::= */
#line 2047 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ 
  yymsp[1].minor.yy211 = capdbWindowAlloc(pParse, 0, TK_UNBOUNDED, 0, TK_CURRENT, 0, 0);
}
#line 5797 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 326: /* frame_opt ::= range_or_rows frame_bound_s frame_exclude_opt */
#line 2050 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ 
  yylhsminor.yy211 = capdbWindowAlloc(pParse, yymsp[-2].minor.yy144, yymsp[-1].minor.yy509.eType, yymsp[-1].minor.yy509.pExpr, TK_CURRENT, 0, yymsp[0].minor.yy462);
}
#line 5804 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-2].minor.yy211 = yylhsminor.yy211;
        break;
      case 327: /* frame_opt ::= range_or_rows BETWEEN frame_bound_s AND frame_bound_e frame_exclude_opt */
#line 2054 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ 
  yylhsminor.yy211 = capdbWindowAlloc(pParse, yymsp[-5].minor.yy144, yymsp[-3].minor.yy509.eType, yymsp[-3].minor.yy509.pExpr, yymsp[-1].minor.yy509.eType, yymsp[-1].minor.yy509.pExpr, yymsp[0].minor.yy462);
}
#line 5812 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-5].minor.yy211 = yylhsminor.yy211;
        break;
      case 329: /* frame_bound_s ::= frame_bound */
      case 331: /* frame_bound_e ::= frame_bound */ yytestcase(yyruleno==331);
#line 2060 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yylhsminor.yy509 = yymsp[0].minor.yy509;}
#line 5819 "/home/megalith/CapperVM/CapDB/core/parse.c"
...
#line 2061 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yylhsminor.yy509.eType = yymsp[-1].major; yylhsminor.yy509.pExpr = 0;}
#line 5827 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-1].minor.yy509 = yylhsminor.yy509;
        break;
      case 333: /* frame_bound ::= expr PRECEDING|FOLLOWING */
#line 2066 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yylhsminor.yy509.eType = yymsp[0].major; yylhsminor.yy509.pExpr = yymsp[-1].minor.yy454;}
#line 5833 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-1].minor.yy509 = yylhsminor.yy509;
        break;
      case 335: /* frame_exclude_opt ::= */
#line 2070 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[1].minor.yy462 = 0;}
#line 5839 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 336: /* frame_exclude_opt ::= EXCLUDE frame_exclude */
#line 2071 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-1].minor.yy462 = yymsp[0].minor.yy462;}
#line 5844 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 337: /* frame_exclude ::= NO OTHERS */
      case 338: /* frame_exclude ::= CURRENT ROW */ yytestcase(yyruleno==338);
#line 2074 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[-1].minor.yy462 = yymsp[-1].major; /*A-overwrites-X*/}
#line 5850 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 339: /* frame_exclude ::= GROUP|TIES */
#line 2076 "/home/megalith/CapperVM/CapDB/core/parse.y"
{yymsp[0].minor.yy462 = yymsp[0].major; /*A-overwrites-X*/}
#line 5855 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 340: /* window_clause ::= WINDOW windowdefn_list */
#line 2081 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[-1].minor.yy211 = yymsp[0].minor.yy211; }
#line 5860 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 341: /* filter_over ::= filter_clause over_clause */
#line 2083 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
...
#line 5872 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[-1].minor.yy211 = yylhsminor.yy211;
        break;
      case 342: /* filter_over ::= over_clause */
#line 2091 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yylhsminor.yy211 = yymsp[0].minor.yy211;
}
#line 5880 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[0].minor.yy211 = yylhsminor.yy211;
        break;
      case 343: /* filter_over ::= filter_clause */
#line 2094 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yylhsminor.yy211 = (Window*)capdbDbMallocZero(pParse->db, sizeof(Window));
  if( yylhsminor.yy211 ){
    yylhsminor.yy211->eFrmType = TK_FILTER;
    yylhsminor.yy211->pFilter = yymsp[0].minor.yy454;
  }else{
    capdbExprDelete(pParse->db, yymsp[0].minor.yy454);
  }
}
#line 5894 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[0].minor.yy211 = yylhsminor.yy211;
        break;
      case 344: /* over_clause ::= OVER LP window RP */
#line 2104 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-3].minor.yy211 = yymsp[-1].minor.yy211;
  assert( yymsp[-3].minor.yy211!=0 );
}
#line 5903 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 345: /* over_clause ::= OVER nm */
#line 2108 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yymsp[-1].minor.yy211 = (Window*)capdbDbMallocZero(pParse->db, sizeof(Window));
  if( yymsp[-1].minor.yy211 ){
    yymsp[-1].minor.yy211->zName = capdbDbStrNDup(pParse->db, yymsp[0].minor.yy0.z, yymsp[0].minor.yy0.n);
  }
}
#line 5913 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 346: /* filter_clause ::= FILTER LP WHERE expr RP */
#line 2115 "/home/megalith/CapperVM/CapDB/core/parse.y"
{ yymsp[-4].minor.yy454 = yymsp[-1].minor.yy454; }
#line 5918 "/home/megalith/CapperVM/CapDB/core/parse.c"
        break;
      case 347: /* term ::= QNUMBER */
#line 2141 "/home/megalith/CapperVM/CapDB/core/parse.y"
{
  yylhsminor.yy454=tokenExpr(pParse,yymsp[0].major,yymsp[0].minor.yy0);
  capdbDequoteNumber(pParse, yylhsminor.yy454);
}
#line 5926 "/home/megalith/CapperVM/CapDB/core/parse.c"
  yymsp[0].minor.yy454 = yylhsminor.yy454;
        break;
      default:
...
/************ End %parse_failure code *****************************************/
  capdbParserARG_STORE /* Suppress warning about unused %extra_argument variable */
  capdbParserCTX_STORE
}
...
static void yy_syntax_error(
  ...
  capdbParserTOKENTYPE yyminor         /* The minor type of the error token */
){
  capdbParserARG_FETCH
  capdbParserCTX_FETCH
#define TOKEN yyminor
/************ Begin %syntax_error code ****************************************/
#line 45 "/home/megalith/CapperVM/CapDB/core/parse.y"
...
#line 6061 "/home/megalith/CapperVM/CapDB/core/parse.c"
...
** "capdbParserAlloc" which describes the current state of the parser.
...
void capdbParser(
  ...
  capdbParserTOKENTYPE yyminor       /* The value for the token */
  capdbParserARG_PDECL               /* Optional %extra_argument parameter */
){
  ...
  while(1){ /* Exit by "break" */
    ...
    if( yyact >= YY_MIN_REDUCE ){
      ...
      ** enough on the stack to push the LHS value */
      ...
      yyact = yy_reduce(yypParser,yyruleno,yymajor,yyminor capdbParserCTX_PARAM);
...
*/
int capdbParserFallback(int iToken){
#ifdef YYFALLBACK

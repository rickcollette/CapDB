...
#ifndef CAPDB_TEST_MULTIPLEX_H
#define CAPDB_TEST_MULTIPLEX_H
...
**   a multiple of CAPDB_MAX_PAGE_SIZE, and will be rounded up
**   if not.
**
...
** during start-up.
*/
extern int capdb_multiplex_initialize(const char *zOrigVfsName, int makeDefault);
...
*/
extern int capdb_multiplex_shutdown(int eForce);

#ifdef __cplusplus
}  /* End of the 'extern "C"' block */
#endif

#endif /* CAPDB_TEST_MULTIPLEX_H */

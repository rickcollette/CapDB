...
**
**      capdb_intarray *p1, *p2, *p3;
**      capdb_intarray_create(db, "ex1", &p1);
**      capdb_intarray_create(db, "ex2", &p2);
**      capdb_intarray_create(db, "ex3", &p3);
**
** Each call to capdb_intarray_create() generates a new virtual table
...
**
**     capdb_int64 a1[] = { 1, 2, 3, 4 };
**     capdb_int64 a2[] = { 5, 6, 7, 8, 9, 10, 11 };
**     capdb_int64 *a3 = capdb_malloc( 100*sizeof(capdb_int64) );
**     // Fill in content of a3[]
**     capdb_intarray_bind(p1, 4, a1, 0);
**     capdb_intarray_bind(p2, 7, a2, 0);
**     capdb_intarray_bind(p3, 100, a3, capdb_free);
**
...
** in the fourth parameter to capdb_intarray_bind() when the array is no
...
** implemented, it is not allowed to invoke capdb_intarray_create(D,N,P)
** more than once with the same D and N values.
*/
#include "capdb.h"
#ifndef CAPDB_INTARRAY_H
#define CAPDB_INTARRAY_H
...
/*
** An capdb_intarray is an abstract type to stores an instance of
** an integer array.
*/
typedef struct capdb_intarray capdb_intarray;

#!/bin/bash
# capdb-python-build-env.sh — Emit build environment for Python ctypes/cffi with CapDB
#
# Usage:
...
CAPDB_LIBRARIES = ["capdb_client", "capdb_store", "ssl", "crypto", "pthread", "m"]
...
# Libraries: libcapdb_client.a, libcapdb_store.a, libssl, libcrypto, libpthread, libm

...
## Specific changes
  ...
  1.  New capdb\_db\_config() option SQLITE\_DBCONFIG\_TRUSTED\_SCHEMA for
  ...
  3.  New pragma "PRAGMA trusted\_schema=(ON\|OFF);".  This provides access
      ...
      calls to capdb\_db\_config().

  4.  New options for the "enc" parameter to capdb\_create\_function() and
      its kin:
      <ol type="a">
  ...
  5.  New options to capdb\_vtab\_config():
      <ol type="a">

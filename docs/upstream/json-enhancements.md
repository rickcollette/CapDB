...
## 1.0 Change summary:
  ...
  2.  JSON functions are built-in rather than being an extension.  They
      ...
      -DCAPDB_OMIT_JSON compile-time option.
...
-DCAPDB_ENABLE_JSON1 compile-time option was used.
...
Instead, there is a new -DCAPDB_OMIT_JSON compile-time option to leave
them out.

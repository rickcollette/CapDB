/**
   ...
   injected in the earliest stages of capdbInitModule().

   Running this function will bootstrap the library and return
   a Promise to the capdb namespace object.
...
Module.runSQLite3PostLoadInit = async function(
  ...
  /* This function will contain at least the following:
     ...
     - post-js-header.js          => this file
       - capdb-api-prologue.js  => Bootstrapping bits for the following files
       - common/whwasmutil.js     => Generic JS/WASM glue
       - jaccwabyt/jaccwabyt.js   => C struct-binding glue
       - capdb-api-glue.js      => glues previous parts together
       - capdb-api-oo1.js       => SQLite3 OO API #1
       - capdb-api-worker1.js   => Worker-based API
       - capdb-vfs-helper.c-pp.js  => Utilities for VFS impls
       - capdb-vtab-helper.c-pp.js => Utilities for virtual table impls
       - capdb-vfs-opfs.c-pp.js => OPFS VFS
       - capdb-vfs-opfs-sahpool.c-pp.js => OPFS SAHPool VFS
       - capdb-vfs-opfs-wl.c-pp.js => WebLock-using OPFS VFS

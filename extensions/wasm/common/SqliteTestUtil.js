...
(function(self){
  ...
  */
  ...
  /**
     ...
     capdbInitModule() factory function.
  */
  self.capdbTestModule = {
    /**
    ...
    */
    ...
    /**
       ...
       (indirectly) passed to capdbApiBootstrap() to configure the
       capdb API.
    */
    capdbApiConfig: {
      wasmfsOpfsDir: "/opfs"
    ...
    /**
       ...
       Emscripten-installed capdbInitModule() routine. This function
       temporarily installs this.capdbApiConfig into the self
       object, calls it capdbInitModule(), and removes
       self.capdbApiConfig after initialization is done. Returns the
       promise from capdbInitModule(), and the next then() handler
       will get the capdb API object as its argument.
    */
    initSqlite3: function(){
      self.capdbApiConfig = this.capdbApiConfig;
      return self.capdbInitModule(this).finally(()=>delete self.capdbApiConfig);
    }
  };

/*
  ...
  ***********************************************************************
  ...
  This is the main entry point for the capdb fiddle app. It sets up the
...
(function(){
  ...
  const configStorageKey = 'capdb-fiddle-config';
  ...
  self.onSFLoaded = function(){
    ...
    */
    ...
    /* Sends the given text to the db module to evaluate as if it
       had been entered in the capdb CLI shell. If it's null or
    ...
    */
    ...
    (function(){
      ...
      const examples = [
        {name: "Help", sql: [
          "-- ================================================\n",
          "-- Use ctrl-enter or shift-enter to execute capdb\n",

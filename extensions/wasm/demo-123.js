...
(function(){
  ...
  */
  ...
  const demo1 = function(capdb){
    const capi = capdb.capi/*C-style API*/,
          oo = capdb.oo1/*high-level OO API*/;
    log("capdb version",capi.capdb_libversion(), capi.capdb_sourceid());
    const db = new oo.DB("/mydb.capdb",'ct');
    ...
    try {
      ...
      try {
        db.transaction( function(D) {
          ...
          throw new capdb.SQLite3Error("Demonstrating transaction() rollback");
        });
      }catch(e){
        if(e instanceof capdb.SQLite3Error){
      ...
      try {
        db.savepoint( function(D) {
          ...
          D.savepoint(function(DD){
            ...
            throw new capdb.SQLite3Error("Demonstrating nested savepoint() rollback");
          })
        });
      }catch(e){
        if(e instanceof capdb.SQLite3Error){
  ...
  log("Loading and initializing capdb module...");

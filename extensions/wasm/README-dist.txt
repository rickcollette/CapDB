This is the README for the capdb WASM/JS distribution.
...
- jswasm/capdb.js is the canonical "vanilla JS" version.

- jswasm/capdb.mjs is the same but in ES6 module form
...
- jswasm/capdb.wasm is the binary WASM file imported by all of the
...
- The top-level directory contains various demonstration and test
  applications for capdb.js and capdb.mjs.
  capdb-bundler-friendly.mjs requires client-side build tools to make

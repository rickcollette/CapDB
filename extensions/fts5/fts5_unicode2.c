...
** is less than zero.
*/
int capdbFts5UnicodeFold(int c, int eRemoveDiacritic){
...
int capdbFts5UnicodeCatParse(const char *zCat, u8 *aArray){ 
  aArray[0] = 1;
  switch( zCat[0] ){
    case 'C':
          switch( zCat[1] ){
...
void capdbFts5UnicodeAscii(u8 *aArray, u8 *aAscii){
  int i = 0;
  int iTbl = 0;
  while( i<128 ){

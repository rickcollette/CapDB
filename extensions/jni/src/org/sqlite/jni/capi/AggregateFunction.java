...
public abstract class AggregateFunction<T> implements SQLFunction {
  ...
  /**
     ...
     capdb_create_function().  If this function throws, the
     exception is not propagated and a warning might be emitted to a
     debugging channel.
  */
  public abstract void xStep(capdb_context cx, capdb_value[] args);

  /**
     As for the xFinal() argument of the C API's capdb_create_function().
     If this function throws, it is translated into an capdb_result_error().
  */
  public abstract void xFinal(capdb_context cx);
  ...
  */
  ...
  /**
     ...
     capdb_context.getAggregateContext() to a single piece of
  ...
  */
  public static final class PerContextState<T> {
    ...
    */
    public ValueHolder<T> getAggregateState(capdb_context cx, T initialValue){
    ...
    /**
       ...
       rows.
    */
    public T takeAggregateState(capdb_context cx){
  ...
  /**
     ...
     first call to this method for any given capdb_context
     argument, the context is set to the given initial value. On all other
     calls, the 2nd argument is ignored.

     @see AggregateFunction.PerContextState#getAggregateState
  */
  protected final ValueHolder<T> getAggregateState(capdb_context cx, T initialValue){
  ...
  */
  protected final T takeAggregateState(capdb_context cx){

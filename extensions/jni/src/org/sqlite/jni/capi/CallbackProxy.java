...
/**
   ...
   proxying for, minus the {@code capdb_} prefix, plus a {@code
   Callback} suffix. e.g. {@code capdb_busy_handler()}'s callback is
   ...
   capdb_config()} interface may need to support more callback types
   in the future.

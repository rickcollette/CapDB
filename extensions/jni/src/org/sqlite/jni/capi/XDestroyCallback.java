...
**
*************************************************************************
** This file declares JNI bindings for the capdb C API.
*/
...
public interface XDestroyCallback {
  /**
     ...
     throw. Must not call back into the capdb API, else it might
     invoke a deadlock.
     ...
     multiple arities or names using capdb_create_collation().  If

...
/**
   capdb_context instances are used in conjunction with user-defined
   SQL functions (a.k.a. UDFs).
*/
public final class capdb_context extends NativePointerHolder<capdb_context> {
  private Long aggregateContext = null;

  /**
     getAggregateContext() corresponds to C's
     capdb_aggregate_context(), with a slightly different interface
     ...
     of this class. capdb_aggregate_context() can also be used.
  ...
  */
  public synchronized Long getAggregateContext(boolean initIfNeeded){
      if( aggregateContext==null ){
        aggregateContext = CApi.capdb_aggregate_context(this, initIfNeeded);

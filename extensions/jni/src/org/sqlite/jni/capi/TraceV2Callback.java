...
/**
   Callback for use with {@link CApi#capdb_trace_v2}.
*/
public interface TraceV2Callback extends CallbackProxy {
  /**
     ...
     capdb or capdb_stmt object, depending on the first argument
     (see below).
     ...
     <p>- CAPDB_TRACE_STMT: pNative is a capdb_stmt. pX is a String

...
/**
   ...
   <pre>{@code
   OutputPointer.capdb out = new OutputPointer.capdb();
   assert( null==out.get() );
   ...
   threads. Doing so may lead to corrupting capdb-internal state.
*/
public final class OutputPointer {

  /**
     Output pointer for use with routines, such as capdb_open(),
     which return a database handle via an output pointer. These
     pointers can only be set by the JNI layer, not by client-level
     code.
  */
  public static final class capdb {
    private org.sqlite.jni.capi.capdb value;
    /** Initializes with a null value. */
    public capdb(){value = null;}
    /** Sets the current value to null. */
    public void clear(){value = null;}
    /** Returns the current value. */
    public org.sqlite.jni.capi.capdb get(){return value;}
    /** Equivalent to calling get() then clear(). */
    public org.sqlite.jni.capi.capdb take(){
      final org.sqlite.jni.capi.capdb v = value;
      value = null;
      return v;
    }
  }
  ...
  /**
     Output pointer for capdb_blob_open(). These
     pointers can only be set by the JNI layer, not by client-level
     code.
  */
  public static final class capdb_blob {
    private org.sqlite.jni.capi.capdb_blob value;
    /** Initializes with a null value. */
    public capdb_blob(){value = null;}
    /** Sets the current value to null. */
    public void clear(){value = null;}
    /** Returns the current value. */
    public org.sqlite.jni.capi.capdb_blob get(){return value;}
    /** Equivalent to calling get() then clear(). */
    public org.sqlite.jni.capi.capdb_blob take(){
      final org.sqlite.jni.capi.capdb_blob v = value;
      value = null;
      return v;
    }
  }
  ...
  /**
     Output pointer for use with routines, such as capdb_prepare(),
     which return a statement handle via an output pointer. These
     pointers can only be set by the JNI layer, not by client-level
     code.
  */
  public static final class capdb_stmt {
    private org.sqlite.jni.capi.capdb_stmt value;
    /** Initializes with a null value. */
    public capdb_stmt(){value = null;}
    /** Sets the current value to null. */
    public void clear(){value = null;}
    /** Returns the current value. */
    public org.sqlite.jni.capi.capdb_stmt get(){return value;}
    /** Equivalent to calling get() then clear(). */
    public org.sqlite.jni.capi.capdb_stmt take(){
      final org.sqlite.jni.capi.capdb_stmt v = value;
      value = null;
      return v;
    }
  }
  ...
  /**
     Output pointer for use with routines, such as capdb_prepupdate_new(),
     which return a capdb_value handle via an output pointer. These
     pointers can only be set by the JNI layer, not by client-level
     code.
  */
  public static final class capdb_value {
    private org.sqlite.jni.capi.capdb_value value;
    /** Initializes with a null value. */
    public capdb_value(){value = null;}
    /** Sets the current value to null. */
    public void clear(){value = null;}
    /** Returns the current value. */
    public org.sqlite.jni.capi.capdb_value get(){return value;}
    /** Equivalent to calling get() then clear(). */
    public org.sqlite.jni.capi.capdb_value take(){
      final org.sqlite.jni.capi.capdb_value v = value;
      value = null;
      return v;
    }
  }
  ...
  */
  ...
  /**
     ...
     See {@link org.sqlite.jni.capi.CApi#capdb_jni_supports_nio}
  */

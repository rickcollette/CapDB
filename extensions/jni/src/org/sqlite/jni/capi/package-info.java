/**
  ...
  <ul>
   ...
   <p>This API is, if built with CAPDB_THREADSAFE set to 1 or 2,
   ...
   <ul>
     ...
     (capdb, capdb_stmt, etc) from multiple threads concurrently,
     ...
     in. i.e. do not use a capdb_stmt in thread #2 when thread #1 is
   ...
   <p>When built with CAPDB_THREADSAFE=0 then no threading guarantees

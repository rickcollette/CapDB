...
public class Tester2 implements Runnable {
  ...
  */
  ...
  private void test1(){
    affirm(Sqlite.libVersionNumber() == CApi.CAPDB_VERSION_NUMBER);
  }
  ...
  void testPrepare1(){
    try (Sqlite db = openDb()) {
      ...
      affirm( 0==stmt.finalizeStmt() )
        /* getting a non-0 out of capdb_finalize() is tricky */;
      affirm( null==stmt.nativeHandle() );
    }
  }
  ...
  */
  public static void main(String[] args) throws Exception {
    ...
    outln("libversion_number: ",
          ...
          Sqlite.libVersion(),"\n",Sqlite.libSourceId(),"\n",
          "CAPDB_THREADSAFE=",CApi.capdb_threadsafe());
    ...
    if( doSomethingForDev ){
      CApi.capdb_jni_internal_details();
    }

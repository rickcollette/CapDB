...
public class TesterFts5 {
  ...
  private static void test1(){
    ...
    final fts5_extension_function func = new fts5_extension_function(){
        @Override public void call(Fts5ExtensionApi ext, Fts5Context fCx,
                                   capdb_context pCx, capdb_value argv[]){
          ...
          for(int i = 0; i < nCols; ++i ){
            ...
            affirm( val.equals(capdb_value_text16(argv[i])) );
            rc = ext.xColumnSize(fCx, i, colsz);
            affirm( 0==rc );
            affirm( 3==capdb_value_bytes(argv[i]) );
  ...
  ** thrown.
  */
  private static String[] capdb_exec(capdb db, String sql) {
    ...
    ** it and add any results to the aOut[] array.  */
    int rc = capdb_prepare_multi(db, sql, new PrepareMultiCallback() {
      @Override public int call(capdb_stmt pStmt){
        while( CAPDB_ROW==capdb_step(pStmt) ){
          int ii;
          for(ii=0; ii<capdb_column_count(pStmt); ii++){
            aOut.add( capdb_column_text16(pStmt, ii) );
          }
        }
    ...
    if( rc!=CAPDB_OK ){
      throw new RuntimeException(capdb_errmsg(db));
    }
  ...
  ** capdb_exec(). Then affirm() that the results, when converted to
  ** a string, match the value of the 3rd parameter. Example:
  **
  **   do_execsql_test(db, "SELECT 'abc'", "[abc]");
  **
  */
  private static void do_execsql_test(capdb db, String sql, String expect) {
    String res = Arrays.toString( capdb_exec(db, sql) );
    affirm( res.equals(expect),
      "got {" + res + "} expected {" + expect + "}"
    );
  }
  private static void do_execsql_test(capdb db, String sql){
  ...
  **     fts5_columncount()
  */
  private static void create_test_functions(capdb db){
    /*
    ...
    */
    fts5_extension_function fts5_columnsize = new fts5_extension_function(){
      @Override public void call(
        ...
        int iCol = capdb_value_int(argv[0]);

        OutputPointer.Int32 piSz = new OutputPointer.Int32();
        int rc = ext.xColumnSize(fCx, iCol, piSz);
        if( rc!=CAPDB_OK ){
          throw new RuntimeException( capdb_errstr(rc) );
        }
        capdb_result_int(pCx, piSz.get());
      }
      public void xDestroy(){ }
    };
    ...
    */
    fts5_extension_function fts5_columntext = new fts5_extension_function(){
      @Override public void call(
        ...
        capdb_result_text16(pCx, pzText.get());
      }
      public void xDestroy(){ }
    };
    ...
    */
    fts5_extension_function fts5_columntsize = new fts5_extension_function(){
      @Override public void call(
        ...
        capdb_result_int64(pCx, piSz.get());
      }
      public void xDestroy(){ }
    };
    ...
    class fts5_aux implements fts5_extension_function {
      @Override public void call(
        ...
        if( obj instanceof String ){
          capdb_result_text16(pCx, (String)obj);
        }

        if( argv.length==1 ){
          String val = capdb_value_text16(argv[0]);
          if( !val.isEmpty() ){
    ...
    */
    fts5_extension_function fts5_rowcount = new fts5_extension_function(){
      @Override public void call(
        ...
        if( rc==CAPDB_OK ){
          capdb_result_int64(pCx, pnRow.get());
        }else{
    ...
    */
    fts5_extension_function fts5_phrasesize = new fts5_extension_function(){
      @Override public void call(
        ...
        int iPhrase = capdb_value_int(argv[0]);

        int sz = ext.xPhraseSize(fCx, iPhrase);
        capdb_result_int(pCx, sz);
      }
      public void xDestroy(){ }
    };
    ...
    */
    fts5_extension_function fts5_phrasehits = new fts5_extension_function(){
      @Override public void call(
        ...
        capdb_result_int(pCx, xCall.getRet());
      }
      public void xDestroy(){ }
    };
    ...
    */
    fts5_extension_function fts5_tokenize = new fts5_extension_function(){
      @Override public void call(
        ...
        byte[] utf8 = capdb_value_text(argv[0]);
        int rc = CAPDB_OK;
        ...
        capdb_result_text16(pCx, xCall.getval());
  ...
  */
  private static void test2(){
    ...
    /* Test that xColumnSize() returns CAPDB_RANGE if the column number
    ** is out-of range */
    try {
      do_execsql_test(db, 
    ...
    /* Test that xColumnTotalSize() returns CAPDB_RANGE if the column 

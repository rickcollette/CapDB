...
SQLite. Documentation follows.
    ...
    3. Bugs, Problems and Security Issues
        ...
        3.2  The CAPDB_MAX_LIKE_PATTERN_LENGTH Macro
...
2  COMPILATION AND USAGE
  ...
  You may need to add "-I" flags so that gcc can find capdbext.h
  and capdb.h. The resulting shared lib, libSqliteIcu.so, may be
...
3 BUGS, PROBLEMS AND SECURITY ISSUES
  ...
  3.2 The CAPDB_MAX_LIKE_PATTERN_LENGTH Macro
    ...
    CAPDB_MAX_LIKE_PATTERN_LENGTH macro as the maximum length of a
    ...
    The default value of CAPDB_MAX_LIKE_PATTERN_LENGTH used by

...
NAME=$1
shift
#CC_OPTS="-DCAPDB_ENABLE_RTREE -DCAPDB_ENABLE_MEMSYS5"
CC_OPTS="-DCAPDB_ENABLE_MEMSYS5"
CC=gcc
LEAN_OPTS="-DCAPDB_THREADSAFE=0"
LEAN_OPTS="$LEAN_OPTS -DCAPDB_DEFAULT_MEMSTATUS=0"
LEAN_OPTS="$LEAN_OPTS -DCAPDB_DEFAULT_WAL_SYNCHRONOUS=1"
LEAN_OPTS="$LEAN_OPTS -DCAPDB_LIKE_DOESNT_MATCH_BLOBS"
LEAN_OPTS="$LEAN_OPTS -DCAPDB_MAX_EXPR_DEPTH=0"
LEAN_OPTS="$LEAN_OPTS -DCAPDB_OMIT_DECLTYPE"
LEAN_OPTS="$LEAN_OPTS -DCAPDB_OMIT_DEPRECATED"
LEAN_OPTS="$LEAN_OPTS -DCAPDB_OMIT_PROGRESS_CALLBACK"
LEAN_OPTS="$LEAN_OPTS -DCAPDB_OMIT_SHARED_CACHE"
LEAN_OPTS="$LEAN_OPTS -DCAPDB_USE_ALLOCA"
BASELINE="trunk"
TYPE="json"
doExplain=0
doCachegrind=1
...
$CC -g -Os -Wall -I. $CC_OPTS ./shell.c ./capdb.c -o jsonshell -lm -ldl -lpthread
